...
*class*torchrl.envs.MicroDuckTaskSampler(*weights: Sequence[float] | [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor) | None = None*, ***, *task_ids: Sequence[int] | [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor) | None = None*, *task_id_key: NestedKey = 'task_id'*, *seed: int | None = None*)[[source]](../../_modules/torchrl/envs/custom/mujoco/microduck.html#MicroDuckTaskSampler)

Write a [`MicroDuckEnv`](torchrl.envs.MicroDuckEnv.html#torchrl.envs.MicroDuckEnv) `task_id` per env at reset from a weighted mixture.
...
which `TransformedEnv` forwards to the env because
...
**weights** ([*Sequence*](torchrl.data.Sequence.html#torchrl.data.Sequence)*[**float**] or*[*torch.Tensor*](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)*,**optional*) - one non-negative
sampling weight per task of the env's library, in library order.
Exactly one of `weights` and `task_ids` must be given.

Keyword Arguments:

- **task_ids** ([*Sequence*](torchrl.data.Sequence.html#torchrl.data.Sequence)*[**int**] or*[*torch.Tensor*](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)*,**optional*) - one fixed task
...
`TransformedEnv`, `env.set_seed` seeds it
as well.
...
... )
>>> env.rollout(50)["task_id"][:, 0, 0] # one task per env 
>>> sampler.probabilities.copy_(torch.tensor([0.0, 0.0, 1.0]))
```
...
*classmethod*fixed(*task_ids: Sequence[int] | [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)*, ***, *task_id_key: NestedKey = 'task_id'*) → MicroDuckTaskSampler[[source]](../../_modules/torchrl/envs/custom/mujoco/microduck.html#MicroDuckTaskSampler.fixed)
...
forward(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/envs/custom/mujoco/microduck.html#MicroDuckTaskSampler.forward)
...
sample(*batch_size: [Size](https://docs.pytorch.org/docs/stable/size.html#torch.Size)*) → [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)[[source]](../../_modules/torchrl/envs/custom/mujoco/microduck.html#MicroDuckTaskSampler.sample)
