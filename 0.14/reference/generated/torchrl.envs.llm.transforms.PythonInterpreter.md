...
*class*torchrl.envs.llm.transforms.PythonInterpreter(*tokenizer=None*, *tool_name: str = 'tool'*, *persistent: bool = False*, *timeout: float = 10.0*, *services: str | None = None*, *service_name: str = 'python_executor'*, *namespace: str | None = None*)[[source]](../../_modules/torchrl/envs/llm/transforms/tools.html#PythonInterpreter)

A transform that executes Python code in the LLM response.

This transform inherits from `ToolTransformBase` and handles all the
...
clone()[[source]](../../_modules/torchrl/envs/llm/transforms/tools.html#PythonInterpreter.clone)

Clone the transform.

close()[[source]](../../_modules/torchrl/envs/llm/transforms/tools.html#PythonInterpreter.close)
