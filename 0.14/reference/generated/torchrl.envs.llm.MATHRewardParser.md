...
*class*torchrl.envs.llm.MATHRewardParser(*tokenizer=None*, *in_keys: list[NestedKey] | None = None*, *out_keys: list[NestedKey] | None = None*, *eos_token: str | None = None*, *set_done_if_answer: bool = True*, *input_mode: Literal['history', 'text', 'tokens'] | None = None*, *format_reward: float = 0.1*, *correct_reward: float = 1.0*)[[source]](../../_modules/torchrl/envs/llm/reward/math.html#MATHRewardParser)

Reward parser for the MATH (competition mathematics) dataset.
...
*static*answers_match(*predicted: str*, *reference: str*) → bool[[source]](../../_modules/torchrl/envs/llm/reward/math.html#MATHRewardParser.answers_match)
...
*static*extract_boxed(*text: str*) → str[[source]](../../_modules/torchrl/envs/llm/reward/math.html#MATHRewardParser.extract_boxed)

Extract the content of the last `\boxed{...}` in *text*.

Handles nested braces correctly.

*static*extract_tags(*text: str*) → tuple[str, str][[source]](../../_modules/torchrl/envs/llm/reward/math.html#MATHRewardParser.extract_tags)
...
transform_reward_spec(*reward_spec: [Composite](torchrl.data.Composite.html#torchrl.data.Composite)*) → [Composite](torchrl.data.Composite.html#torchrl.data.Composite)[[source]](../../_modules/torchrl/envs/llm/reward/math.html#MATHRewardParser.transform_reward_spec)
