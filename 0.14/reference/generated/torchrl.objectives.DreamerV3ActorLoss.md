...
[`PercentileValueNorm`](torchrl.modules.PercentileValueNorm.html#torchrl.modules.PercentileValueNorm) submodule
...
*property*return_high*: [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)*

EMA of the high return quantile (0-dim view of `retnorm.high`).

*property*return_low*: [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)*
