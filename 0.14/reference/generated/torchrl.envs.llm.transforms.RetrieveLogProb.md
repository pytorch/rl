...
*class*torchrl.envs.llm.transforms.RetrieveLogProb(*model: [LLMWrapperBase](torchrl.modules.llm.LLMWrapperBase.html#torchrl.modules.llm.LLMWrapperBase)*, ***, *log_probs_full_key: NestedKey | None = None*, *assistant_only: bool = True*, *tokenizer_kwargs: dict | None = None*, *detach: bool = True*, *device: [torch.device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | None = None*, *tokenizer: transformers.AutoTokenizer | None = None*, *padding_side: str = 'left'*)[[source]](../../_modules/torchrl/envs/llm/transforms/kl.html#RetrieveLogProb)
...
with the [`RetrieveKL`](torchrl.envs.llm.transforms.RetrieveKL.html#torchrl.envs.llm.transforms.RetrieveKL) and [`KLComputation`](torchrl.envs.llm.transforms.KLComputation.html#torchrl.envs.llm.transforms.KLComputation) transforms.

Parameters:

**model** ([*LLMWrapperBase*](torchrl.modules.llm.LLMWrapperBase.html#torchrl.modules.llm.LLMWrapperBase)) - the model to use to compute the log-probs.
...
whether to zero out the log-probs of the non-assistant tokens (i.e., steps of history
where the role is not "assistant"). Defaults to True.

Note

When assistant_only=True, the model must have input_mode='history' to properly identify
...
[`RetrieveKL`](torchrl.envs.llm.transforms.RetrieveKL.html#torchrl.envs.llm.transforms.RetrieveKL): A higher-level transform that combines two RetrieveLogProb instances with KLComputation.
[`KLComputation`](torchrl.envs.llm.transforms.KLComputation.html#torchrl.envs.llm.transforms.KLComputation): A transform that computes KL divergence between two log-prob tensors.
...
transform_observation_spec(*observation_spec: [Composite](torchrl.data.Composite.html#torchrl.data.Composite)*) → [Composite](torchrl.data.Composite.html#torchrl.data.Composite)[[source]](../../_modules/torchrl/envs/llm/transforms/kl.html#RetrieveLogProb.transform_observation_spec)
