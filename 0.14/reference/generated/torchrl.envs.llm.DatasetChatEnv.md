...
*class*torchrl.envs.llm.DatasetChatEnv(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/llm/chat.html#DatasetChatEnv)
...
The tokenizer to use for text processing. Defaults to None.

Note

It is recommended to pass a tokenizer to the environment. This is an easy way to ensure that the
template applied to the chat history is consistent with the format required by the model.
- **device** ([*torch.device*](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device)*|**None**,**optional*) - The device to use for computations. Defaults to None.
...
DatasetChatEnv is a thin wrapper around [`ChatEnv`](torchrl.envs.llm.ChatEnv.html#torchrl.envs.llm.ChatEnv) bucketed with a
`DataLoadingPrimer` transform. See these two classes for more insight on data format
and functionality.

See also

Examples of DatasetChatEnv include [`GSM8KEnv`](torchrl.envs.llm.GSM8KEnv.html#torchrl.envs.llm.GSM8KEnv) and [`IFEvalEnv`](torchrl.envs.llm.IFEvalEnv.html#torchrl.envs.llm.IFEvalEnv).
...
add_truncated_keys() → [TransformedEnv](torchrl.envs.transforms.TransformedEnv.html#torchrl.envs.transforms.TransformedEnv)
...
append_transform(*transform: [Transform](torchrl.envs.transforms.Transform.html#torchrl.envs.transforms.Transform) | Callable[[[TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)], [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)]*) → [TransformedEnv](torchrl.envs.transforms.TransformedEnv.html#torchrl.envs.transforms.TransformedEnv)
...
eval() → [TransformedEnv](torchrl.envs.transforms.TransformedEnv.html#torchrl.envs.transforms.TransformedEnv)
...
*classmethod*from_dataloader(*dataloader: DataLoader*, ***, *repeats: int | None = None*, *device: [torch.device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | None = None*, *group_repeats: bool = False*, *batch_size: tuple | [torch.Size](https://docs.pytorch.org/docs/stable/size.html#torch.Size) | None = None*, *primers: [Composite](torchrl.data.Composite.html#torchrl.data.Composite) | None = None*, *tokenizer: transformers.AutoTokenizer | None = None*, *template_kwargs: dict[str, Any] | None = None*, *input_mode: Literal['history', 'text', 'tokens'] = 'history'*, *data_key: str | None = None*, *system_prompt: str | None = None*)[[source]](../../_modules/torchrl/envs/llm/chat.html#DatasetChatEnv.from_dataloader)
...
- **device** ([*torch.device*](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device)*|**None**,**optional*) - The device to use for computations. Defaults to None.
- **group_repeats** (*bool**,**optional*) - Whether to group repeated samples together. Defaults to False.
- **batch_size** (*tuple**|*[*torch.Size*](https://docs.pytorch.org/docs/stable/size.html#torch.Size)*|**None**,**optional*) - The batch size for data loading. Defaults to 1.
- **primers** ([*Composite*](torchrl.data.Composite.html#torchrl.data.Composite)*|**None**,**optional*) - The primers to use for data loading. Defaults to None.
...
[ChatEnv](torchrl.envs.llm.ChatEnv.html#torchrl.envs.llm.ChatEnv)
...
insert_transform(*index: int*, *transform: [Transform](torchrl.envs.transforms.Transform.html#torchrl.envs.transforms.Transform)*) → [TransformedEnv](torchrl.envs.transforms.TransformedEnv.html#torchrl.envs.transforms.TransformedEnv)
...
rand_action(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase) | None = None*) → [TensorDict](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDict.html#tensordict.TensorDict)
...
reset_dataloader()[[source]](../../_modules/torchrl/envs/llm/chat.html#DatasetChatEnv.reset_dataloader)
...
to(**args*, ***kwargs*) → [TransformedEnv](torchrl.envs.transforms.TransformedEnv.html#torchrl.envs.transforms.TransformedEnv)
...
train(*mode: bool = True*) → [TransformedEnv](torchrl.envs.transforms.TransformedEnv.html#torchrl.envs.transforms.TransformedEnv)
