...
*class*torchrl.modules.llm.stateless_init_process_group(*master_address: str | None*, *master_port: str | None*, *rank*, *world_size*, *device=None*)[[source]](../../_modules/torchrl/modules/llm/backends/vllm/vllm_utils.html#stateless_init_process_group)
