...
The [`Evaluator`](generated/torchrl.collectors.Evaluator.html#torchrl.collectors.Evaluator) class provides a unified interface for running evaluation
...
significant training time. The [`Evaluator`](generated/torchrl.collectors.Evaluator.html#torchrl.collectors.Evaluator) decouples evaluation from
...
scripts), use [`evaluate()`](generated/torchrl.collectors.Evaluator.html#torchrl.collectors.Evaluator.evaluate):
...
By default, [`trigger_eval()`](generated/torchrl.collectors.Evaluator.html#torchrl.collectors.Evaluator.trigger_eval) raises if a previous evaluation is
...
Calling [`trigger_eval()`](generated/torchrl.collectors.Evaluator.html#torchrl.collectors.Evaluator.trigger_eval) while a previous evaluation is
...
The [`Evaluator`](generated/torchrl.collectors.Evaluator.html#torchrl.collectors.Evaluator) supports two backends selected via the `backend`
parameter:
...
- Wraps [`RayEvalWorker`](generated/torchrl.collectors.distributed.RayEvalWorker.html#torchrl.collectors.distributed.RayEvalWorker) under the same
API.
...
| [`Evaluator`](generated/torchrl.collectors.Evaluator.html#torchrl.collectors.Evaluator)(env[, policy, policy_factory, ...]) | Unified sync / async evaluator with pluggable backend. |
| --- | --- |