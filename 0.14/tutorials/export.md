...
```
pkg_path /tmp/tmp839161zw/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 631.9540 msec (total = 0.6320 sec since last reset).
TorchRL version took 1995.7476 msec (total = 1.9957 sec since last reset).
```
