...
```
pkg_path /tmp/tmp6jbvbmdf/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 636.9333 msec (total = 0.6369 sec since last reset).
TorchRL version took 1984.5009 msec (total = 1.9845 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.391 seconds)
