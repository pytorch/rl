...
```
pkg_path /tmp/tmp_u0f6w_u/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 636.4977 msec (total = 0.6365 sec since last reset).
TorchRL version took 1943.1252 msec (total = 1.9431 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.567 seconds)
