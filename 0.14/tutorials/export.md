...
class GraphModule(torch.nn.Module):
 ...
 # File: /pytorch/rl/torchrl/modules/tensordict_module/actors.py:655 in forward, code: action = self.action_func_mapping[self.action_space](action_values)
 ...
 # File: /pytorch/rl/torchrl/modules/tensordict_module/actors.py:660 in forward, code: chosen_action_value = action_value_func(action_values, action)
...
```
pkg_path /tmp/tmpxekn1vqd/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 631.4607 msec (total = 0.6315 sec since last reset).
TorchRL version took 2010.8166 msec (total = 2.0108 sec since last reset).
```
