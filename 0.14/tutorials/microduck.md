...
as [`MicroDuckEnv`](../reference/generated/torchrl.envs.MicroDuckEnv.html#torchrl.envs.MicroDuckEnv), a MuJoCo locomotion environment whose
...
- how a [`MicroDuckTask`](../reference/generated/torchrl.envs.MicroDuckTask.html#torchrl.envs.MicroDuckTask) library is built from presets and
stacked with [`torch.stack()`](https://docs.pytorch.org/docs/stable/generated/torch.stack.html#torch.stack);
- how the env picks one task per simulator at reset, and how
[`MicroDuckTaskSampler`](../reference/generated/torchrl.envs.MicroDuckTaskSampler.html#torchrl.envs.MicroDuckTaskSampler) pins or mixes tasks;
...
it with [`VideoRecorder`](../reference/generated/torchrl.record.VideoRecorder.html#torchrl.record.VideoRecorder);
- how to standardize advantages within each task with
[`GAE`](../reference/generated/torchrl.objectives.value.GAE.html#torchrl.objectives.value.GAE) and its `group_key`;
- how to register a reward term of your own with
[`register_reward()`](../reference/generated/torchrl.envs.MicroDuckEnv.html#torchrl.envs.MicroDuckEnv.register_reward);
...
[`MicroDuckTask`](../reference/generated/torchrl.envs.MicroDuckTask.html#torchrl.envs.MicroDuckTask) is a tensorclass: the planar command box
...
and a name. The presets on [`MicroDuckEnv`](../reference/generated/torchrl.envs.MicroDuckEnv.html#torchrl.envs.MicroDuckEnv) fill every
...
vector over [`REWARD_TERMS`](../reference/generated/torchrl.envs.MicroDuckEnv.html#torchrl.envs.MicroDuckEnv.REWARD_TERMS), so the presets
...
`TransformedEnv` forward it at reset).
...
[`MicroDuckTaskSampler`](../reference/generated/torchrl.envs.MicroDuckTaskSampler.html#torchrl.envs.MicroDuckTaskSampler) writes `task_id` at reset for
you: with weights when the mixture should differ from the library's (a
curriculum), or with [`fixed()`](../reference/generated/torchrl.envs.MicroDuckTaskSampler.html#torchrl.envs.MicroDuckTaskSampler.fixed) to give
...
The task is written once against [`MujocoEnv`](../reference/generated/torchrl.envs.MujocoEnv.html#torchrl.envs.MujocoEnv), so the
backend is a constructor argument. `"mujoco"` runs the official C bindings,
one simulator per process with [`ParallelEnv`](../reference/generated/torchrl.envs.ParallelEnv.html#torchrl.envs.ParallelEnv) when
...
[`MJLabWrapper`](../reference/generated/torchrl.envs.MJLabWrapper.html#torchrl.envs.MJLabWrapper) runs those directly, which is a
...
observation. It is a [`TensorDictModuleBase`](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.nn.TensorDictModuleBase.html#tensordict.nn.TensorDictModuleBase), so it is a
...
[`VideoRecorder`](../reference/generated/torchrl.record.VideoRecorder.html#torchrl.record.VideoRecorder) appended to the env collects the
frames of every step. With a logger it writes the video where the logger
lives (W&B, TensorBoard, an mp4 through `CSVLogger`);
here `to_animation()` turns the frames
...
and shrinks the others' learning signal. [`GAE`](../reference/generated/torchrl.objectives.value.GAE.html#torchrl.objectives.value.GAE)
...
episodes replayed from a [`TensorDictReplayBuffer`](../reference/generated/torchrl.data.TensorDictReplayBuffer.html#torchrl.data.TensorDictReplayBuffer), one
[`Evaluator`](../reference/generated/torchrl.collectors.Evaluator.html#torchrl.collectors.Evaluator) per task, the per-task GAE above, and
...
[`fixed()`](../reference/generated/torchrl.envs.MicroDuckTaskSampler.html#torchrl.envs.MicroDuckTaskSampler.fixed). With the shipped defaults
...
- [`MicroDuckEnv`](../reference/generated/torchrl.envs.MicroDuckEnv.html#torchrl.envs.MicroDuckEnv) and [`MicroDuckTask`](../reference/generated/torchrl.envs.MicroDuckTask.html#torchrl.envs.MicroDuckTask)
for every field and preset.
- [`MujocoEnv`](../reference/generated/torchrl.envs.MujocoEnv.html#torchrl.envs.MujocoEnv) for the base class and its backends.
- [`GAE`](../reference/generated/torchrl.objectives.value.GAE.html#torchrl.objectives.value.GAE) for `group_key`.
- rlrender_tuto for rendering checkpoints outside training.
- `examples/microduck/README.md` for the training recipe and the results
of the multi-task runs.

**Total running time of the script:** (0 minutes 53.700 seconds)

[`Download Jupyter notebook: microduck.ipynb`](../_downloads/87abf301cfa889a7c2c1c1bbc88875ef/microduck.ipynb)

[`Download Python source code: microduck.py`](../_downloads/a599438bedef7cbf6b8409c9bdc2f081/microduck.py)

[`Download zipped: microduck.zip`](../_downloads/0b60528c8ac32bc53e7cce9ec7e67c3a/microduck.zip)
