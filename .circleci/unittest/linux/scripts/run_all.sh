...
python .circleci/unittest/helpers/coverage_run_parallel.py -m pytest --instafail --durations 200 --ignore test/test_distributed.py --ignore test/test_rlhf.py --ignore test/test_collector.py --ignore test/test_env.py --ignore test/test_transforms.py
coverage combine
coverage xml -i
