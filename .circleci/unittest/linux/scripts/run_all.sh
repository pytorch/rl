...
python .circleci/unittest/helpers/coverage_run_parallel.py -m pytest test --instafail --durations 200 --ignore test/test_distributed.py --ignore test/test_rlhf.py
coverage combine
coverage xml -i
