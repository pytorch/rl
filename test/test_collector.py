...
def test_collector_vecnorm_envcreator():
    ...
    last_seed = init_seed
    # The numpy rng generated sequence generated by initial seed is seeded to the collectors/environments.
    # Therefore, init_seed itself is actually not seeded.
    for i in range(num_envs * num_data_collectors):
        last_seed = seed_generator(last_seed)
