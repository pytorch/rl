...
from torchrl.envs.transforms import MeanActionSelector, TensorDictPrimer, TransformedEnv
...
@pytest.mark.parametrize("device", get_default_devices())
class TestDreamerV3(LossModuleTestBase):
    img_size = (64, 64)
    ...
    def test_dreamer_v3_two_hot_roundtrip(self, device):
        ...
        assert torch.allclose(encoded.sum(-1), torch.ones(9), atol=1e-5)
        # Decode as expectation
    ...
    def test_dreamer_v3_kl_balanced_gradients(self, device):
        ...
        from torchrl.objectives.dreamer_v3 import categorical_kl_balanced
