...
@pytest.mark.parametrize(
    ("activation_class", "num_blocks", "num_layers", "batch", "time", "dtype"),
    [
        (torch.nn.SiLU, 1, 1, 1, 1, torch.float32),
        (torch.nn.Tanh, 8, 2, 2, 3, torch.float32),
        (torch.nn.ReLU, 8, 1, 3, 2, torch.bfloat16),
    ],
)
