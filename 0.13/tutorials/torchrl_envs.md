...
```
<matplotlib.image.AxesImage object at 0x7fb7c240dc90>
```
...
```
'bar_0fbd82c2-631a-11f1-a84c-0242ac110002'
```
...
```
<torchrl.envs.batched_envs._dispatch_caller_parallel object at 0x7fb7c2002090>
```
...
```
['bar_115bed3a-631a-11f1-8069-0242ac110002', 'bar_11627e98-631a-11f1-850d-0242ac110002', 'bar_11627e98-631a-11f1-8bee-0242ac110002']
```
...
```
mean: : tensor([-0.3814, 0.1211, 0.1554])
std: : tensor([0.9733, 1.1791, 1.1614])
```
...
data: TensorDict(
 ...
 device=None,
 is_shared=False)
mean: : tensor([-0.3052, 0.2054, -0.0595])
std: : tensor([1.2371, 1.1194, 1.2502])
```
...
**Total running time of the script:** (0 minutes 26.356 seconds)
