...
rollout with transform: TensorDict(
 fields={
 action: Tensor(shape=torch.Size([32, 8]), device=cuda:0, dtype=torch.float32, is_shared=True),
 done: Tensor(shape=torch.Size([32, 1]), device=cuda:0, dtype=torch.bool, is_shared=True),
 next: TensorDict(
 fields={
 done: Tensor(shape=torch.Size([32, 1]), device=cuda:0, dtype=torch.bool, is_shared=True),
 r3m_vec: Tensor(shape=torch.Size([32, 2048]), device=cuda:0, dtype=torch.float32, is_shared=True),
 reward: Tensor(shape=torch.Size([32, 1]), device=cuda:0, dtype=torch.float32, is_shared=True),
 terminated: Tensor(shape=torch.Size([32, 1]), device=cuda:0, dtype=torch.bool, is_shared=True),
 truncated: Tensor(shape=torch.Size([32, 1]), device=cuda:0, dtype=torch.bool, is_shared=True)},
...
rollout, fine tuning: TensorDict(
 ...
 pixels: Tensor(shape=torch.Size([32, 480, 480, 3]), device=cuda:0, dtype=torch.uint8, is_shared=True),
 reward: Tensor(shape=torch.Size([32, 1]), device=cuda:0, dtype=torch.float32, is_shared=True),
 terminated: Tensor(shape=torch.Size([32, 1]), device=cuda:0, dtype=torch.bool, is_shared=True),
 truncated: Tensor(shape=torch.Size([32, 1]), device=cuda:0, dtype=torch.bool, is_shared=True)},
 batch_size=torch.Size([32]),
...
data after sampling: TensorDict(
 ...
 device=cuda:0,
 is_shared=True)
Directory '/tmp/tmp9sdorxg1' deleted successfully.
```

**Total running time of the script:** (0 minutes 50.836 seconds)
