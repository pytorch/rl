...
```
Collected batch: torch.Size([200]), reward: -9.00
Collected batch: torch.Size([200]), reward: -5.22
Collected batch: torch.Size([200]), reward: -6.38
Collected batch: torch.Size([200]), reward: -5.22
...
```
Prioritized sample indices: tensor([65, 31, 26, 44, 25]) ...
```
