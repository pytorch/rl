...
```
Collected batch: torch.Size([200]), reward: -6.05
Collected batch: torch.Size([200]), reward: -6.61
Collected batch: torch.Size([200]), reward: -5.84
Collected batch: torch.Size([200]), reward: -5.18
...
```
Prioritized sample indices: tensor([45, 30, 21, 68, 11]) ...
```
