...
```
pkg_path /tmp/tmpvh9lpdp6/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 695.0090 msec (total = 0.6950 sec since last reset).
TorchRL version took 2233.4840 msec (total = 2.2335 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 24.565 seconds)
