...
```
pkg_path /tmp/tmp3ad7iyqz/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 633.3919 msec (total = 0.6334 sec since last reset).
TorchRL version took 2184.7246 msec (total = 2.1847 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 24.081 seconds)
