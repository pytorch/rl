...
```
pkg_path /tmp/tmpxa_2e__s/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 627.9390 msec (total = 0.6279 sec since last reset).
TorchRL version took 2288.9524 msec (total = 2.2890 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.520 seconds)
