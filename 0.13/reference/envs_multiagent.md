...
TorchRL accommodates all these possible paradigms thanks to its [`tensordict.TensorDict`](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDict.html#tensordict.TensorDict) data carrier.
...
[VMAS](https://github.com/proroklab/VectorizedMultiAgentSimulator), a multi-robot task simulator also
...
| [`MarlGroupMapType`](generated/torchrl.envs.MarlGroupMapType.html#torchrl.envs.MarlGroupMapType)(value[, names, module, ...]) | Marl Group Map Type. |
| --- | --- |
| [`check_marl_grouping`](generated/torchrl.envs.check_marl_grouping.html#torchrl.envs.check_marl_grouping)(group_map, agent_names) | Check MARL group map. |