...
*class*torchrl.weight_update.llm.VLLMDoubleBufferSyncScheme(*remote_addr: str*, *local_addr: str | None = None*, *num_threads: int = 1*, *strategy: Literal['tensordict', 'state_dict'] = 'tensordict'*)[[source]](../../_modules/torchrl/weight_update/llm/vllm_double_buffer.html#VLLMDoubleBufferSyncScheme)
...
create_receiver(*vllm_engine*) → [VLLMDoubleBufferWeightReceiver](torchrl.weight_update.llm.VLLMDoubleBufferWeightReceiver.html#torchrl.weight_update.llm.VLLMDoubleBufferWeightReceiver)[[source]](../../_modules/torchrl/weight_update/llm/vllm_double_buffer.html#VLLMDoubleBufferSyncScheme.create_receiver)
...
create_sender() → [VLLMDoubleBufferWeightSender](torchrl.weight_update.llm.VLLMDoubleBufferWeightSender.html#torchrl.weight_update.llm.VLLMDoubleBufferWeightSender)[[source]](../../_modules/torchrl/weight_update/llm/vllm_double_buffer.html#VLLMDoubleBufferSyncScheme.create_sender)

Create a weight sender for the trainer process.

create_transport(***kwargs*) → [VLLMDoubleBufferTransport](torchrl.weight_update.llm.VLLMDoubleBufferTransport.html#torchrl.weight_update.llm.VLLMDoubleBufferTransport)[[source]](../../_modules/torchrl/weight_update/llm/vllm_double_buffer.html#VLLMDoubleBufferSyncScheme.create_transport)
