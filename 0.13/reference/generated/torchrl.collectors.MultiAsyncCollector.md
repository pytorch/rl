...
*class*torchrl.collectors.MultiAsyncCollector(**args*, *sync: bool | None = None*, ***kwargs*)[[source]](../../_modules/torchrl/collectors/_multi_async.html#MultiAsyncCollector)
...
False, the collector will run in async mode (`MultiAsyncCollector`).
...
load_state_dict(*state_dict: OrderedDict*) → None[[source]](../../_modules/torchrl/collectors/_multi_async.html#MultiAsyncCollector.load_state_dict)
...
receive_weights(*policy_or_weights: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase) | None = None*)[[source]](../../_modules/torchrl/collectors/_multi_async.html#MultiAsyncCollector.receive_weights)
...
reset(*reset_idx: Sequence[bool] | None = None*) → None[[source]](../../_modules/torchrl/collectors/_multi_async.html#MultiAsyncCollector.reset)
...
set_seed(*seed: int*, *static_seed: bool = False*) → int[[source]](../../_modules/torchrl/collectors/_multi_async.html#MultiAsyncCollector.set_seed)
...
shutdown(*timeout: float | None = None*, *close_env: bool = True*, *raise_on_error: bool = True*) → None[[source]](../../_modules/torchrl/collectors/_multi_async.html#MultiAsyncCollector.shutdown)
