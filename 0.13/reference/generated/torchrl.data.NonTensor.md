...
*class*torchrl.data.NonTensor(*shape: [Size](https://docs.pytorch.org/docs/stable/size.html#torch.Size) | int = (1,)*, *device: [device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | str | int | None = None*, *dtype: [dtype](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.dtype) | None = None*, *example_data: Any = None*, *batched: bool | None = None*, *feature_dims: int | None = None*, ***kwargs*)[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor)
...
- **shape** (*Union**[*[*torch.Size*](https://docs.pytorch.org/docs/stable/size.html#torch.Size)*,**int**]**,**optional*) - The shape of the non-tensor data. Defaults to (1,).
- **device** (*Optional**[**DEVICE_TYPING**]**,**optional*) - The device on which the data is stored. Defaults to None.
- **dtype** ([*torch.dtype*](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.dtype)*|**None**,**optional*) - The data type of the non-tensor data. Defaults to None.
...
`Choice` which allows to randomly choose among different specs when calling
rand.
...
cardinality() → Any[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.cardinality)
...
clone() → NonTensor[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.clone)
...
enumerate(*use_mask: bool = False*) → Any[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.enumerate)
...
expand(**shape*)[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.expand)
...
is_in(*val: Any*) → bool[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.is_in)
...
one(*shape=None*)[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.one)
...
rand(*shape=None*)[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.rand)
...
squeeze(*dim: int | None = None*) → NonTensor[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.squeeze)
...
to(*dest: [dtype](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.dtype) | [device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | str | int*) → NonTensor[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.to)

Casts a TensorSpec to a device or a dtype.

Returns the same spec if no change is made.

to_numpy(*val: [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor) | [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*, *safe: bool | None = None*) → ndarray | dict[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.to_numpy)
...
unsqueeze(*dim: int*) → NonTensor[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.unsqueeze)
...
zero(*shape=None*)[[source]](../../_modules/torchrl/data/tensor_specs.html#NonTensor.zero)
