...
*class*torchrl.data.datasets.RobosetExperienceReplay(*dataset_id*, *batch_size: int*, ***, *root: str | Path | None = None*, *download: bool = True*, *sampler: [Sampler](torchrl.data.replay_buffers.Sampler.html#torchrl.data.replay_buffers.Sampler) | None = None*, *writer: [Writer](torchrl.data.replay_buffers.Writer.html#torchrl.data.replay_buffers.Writer) | None = None*, *collate_fn: Callable | None = None*, *pin_memory: bool = False*, *prefetch: int | None = None*, *transform: torchrl.envs.Transform | None = None*, *split_trajs: bool = False*, ***env_kwargs*)[[source]](../../_modules/torchrl/data/datasets/roboset.html#RobosetExperienceReplay)
...
Learn more about roboset here: [https://sites.google.com/view/robohive/roboset](https://sites.google.com/view/robohive/roboset)
