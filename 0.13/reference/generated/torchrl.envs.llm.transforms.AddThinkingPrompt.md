...
*class*torchrl.envs.llm.transforms.AddThinkingPrompt(*cond: Callable[[[TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)], bool]*, *prompt: str | None = None*, *random_prompt: bool = False*, *role: Literal['user', 'assistant'] = 'assistant'*, *edit_last_turn: bool = True*, *zero_reward: bool | None = None*, *undo_done: bool = True*, *egocentric: bool | None = None*)[[source]](../../_modules/torchrl/envs/llm/transforms/reason.html#AddThinkingPrompt)
