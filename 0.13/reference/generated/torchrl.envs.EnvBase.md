...
*class*torchrl.envs.EnvBase(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase)

Abstract environment parent class.

Keyword Arguments:

- **device** ([*torch.device*](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device)) - The device of the environment. Deviceless environments
...
live on that device.
Defaults to `None`.
- **batch_size** ([*torch.Size*](https://docs.pytorch.org/docs/stable/size.html#torch.Size)*or**equivalent**,**optional*) - batch-size of the environment.
...
be done after a call to [`reset()`](torchrl.envs.ModelBasedEnvBase.html#torchrl.envs.reset) is made. Defaults to `False`.
- **policy** ([*torch.nn.Module*](https://docs.pytorch.org/docs/stable/generated/torch.nn.Module.html#torch.nn.Module)*,**optional*) -

a policy module used to infer and
append any environment transforms it needs, such as
[`InitTracker`](torchrl.envs.transforms.InitTracker.html#torchrl.envs.transforms.InitTracker) and recurrent-state
[`TensorDictPrimer`](torchrl.envs.transforms.TensorDictPrimer.html#torchrl.envs.transforms.TensorDictPrimer) transforms.
This returns a `TransformedEnv` when transforms
are added.

Note

The auto-wrapping is achieved by the EnvBase metaclass.
It does not appear in the __init__ method of subclasses
([`GymEnv`](torchrl.envs.GymEnv.html#torchrl.envs.GymEnv),
[`DMControlEnv`](torchrl.envs.DMControlEnv.html#torchrl.envs.DMControlEnv), custom subclasses, etc.)
...
if `True`, the specs are locked and can only be
modified if `set_spec_lock_()` is called.

Note

The locking is achieved by the EnvBase metaclass. It does not appear in the
...
if `True`, the env is assumed to reset automatically
when done. Defaults to `False`.

Note

The auto-resetting is achieved by the EnvBase metaclass. It does not appear in the
__init__ method and is included in the keyword arguments strictly for type-hinting purpose.

See also

The [auto-resetting environments API](../envs_libraries.html#autoresetting-envs) section in the API
documentation.
- **compile** (*bool**or**dict**,**optional*) -

if truthy, the env is compiled right
after construction by calling `compile()`.

- `False` / `None` (default): no compilation.
- `True`: compile with default [`torch.compile()`](https://docs.pytorch.org/docs/stable/generated/torch.compile.html#torch.compile) settings.
- `dict`: kwargs forwarded to `compile()`,
...
- **done_spec** ([*Composite*](torchrl.data.Composite.html#torchrl.data.Composite)) - equivalent to `full_done_spec` as all
`done_specs` contain at least a `"done"` and a `"terminated"` entry
- **action_spec** ([*TensorSpec*](torchrl.data.TensorSpec.html#torchrl.data.TensorSpec)) - the spec of the action. Links to the spec of the leaf
action if only one action tensor is to be expected. Otherwise links to
`full_action_spec`.
- **observation_spec** ([*Composite*](torchrl.data.Composite.html#torchrl.data.Composite)) - equivalent to `full_observation_spec`.
- **reward_spec** ([*TensorSpec*](torchrl.data.TensorSpec.html#torchrl.data.TensorSpec)) - the spec of the reward. Links to the spec of the leaf
reward if only one reward tensor is to be expected. Otherwise links to
`full_reward_spec`.
- **state_spec** ([*Composite*](torchrl.data.Composite.html#torchrl.data.Composite)) - equivalent to `full_state_spec`.
- **full_done_spec** ([*Composite*](torchrl.data.Composite.html#torchrl.data.Composite)) - a composite spec such that `full_done_spec.zero()`
returns a tensordict containing only the leaves encoding the done status of the
environment.
- **full_action_spec** ([*Composite*](torchrl.data.Composite.html#torchrl.data.Composite)) - a composite spec such that `full_action_spec.zero()`
returns a tensordict containing only the leaves encoding the action of the
environment.
- **full_observation_spec** ([*Composite*](torchrl.data.Composite.html#torchrl.data.Composite)) - a composite spec such that `full_observation_spec.zero()`
returns a tensordict containing only the leaves encoding the observation of the
environment.
- **full_reward_spec** ([*Composite*](torchrl.data.Composite.html#torchrl.data.Composite)) - a composite spec such that `full_reward_spec.zero()`
returns a tensordict containing only the leaves encoding the reward of the
environment.
- **full_state_spec** ([*Composite*](torchrl.data.Composite.html#torchrl.data.Composite)) - a composite spec such that `full_state_spec.zero()`
returns a tensordict containing only the leaves encoding the inputs (actions
excluded) of the environment.
- **batch_size** ([*torch.Size*](https://docs.pytorch.org/docs/stable/size.html#torch.Size)) - The batch-size of the environment.
- **device** ([*torch.device*](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device)) - the device where the input/outputs of the environment
are to be expected. Can be `None`.
- **is_spec_locked** (*bool*) - returns `True` if the specs are locked. See the `spec_locked`
argument above.

step(*TensorDictBase -> TensorDictBase*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.step)

step in the environment

reset(*TensorDictBase*, *optional -> TensorDictBase*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.reset)

reset the environment

set_seed(*int -> int*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.set_seed)

sets the seed of the environment

rand_step(*TensorDictBase*, *optional -> TensorDictBase*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.rand_step)

random step given the action spec

rollout(*Callable*, *... -> TensorDictBase*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.rollout)
...
any_done(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → bool[[source]](../../_modules/torchrl/envs/common.html#EnvBase.any_done)
...
append_transform(*transform: [Transform](torchrl.envs.transforms.Transform.html#torchrl.envs.transforms.Transform) | Callable[[TensorDictBase], TensorDictBase]*) → torchrl.envs.TransformedEnv[[source]](../../_modules/torchrl/envs/common.html#EnvBase.append_transform)
...
auto_specs_(*policy: Callable[[[TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)], [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)]*, ***, *tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase) | None = None*, *action_key: NestedKey | list[NestedKey] = 'action'*, *done_key: NestedKey | list[NestedKey] | None = None*, *observation_key: NestedKey | list[NestedKey] = 'observation'*, *reward_key: NestedKey | list[NestedKey] = 'reward'*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.auto_specs_)
...
cardinality(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase) | None = None*) → int[[source]](../../_modules/torchrl/envs/common.html#EnvBase.cardinality)
...
check_env_specs(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.check_env_specs)
...
- **break_when_any_done** (*bool**or**str**,**optional*) - value for `break_when_any_done` in `rollout()`.
...
compile(***, *warmup: int | None = None*, ***kwargs*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.compile)
...
because the first post-[`reset()`](torchrl.envs.ModelBasedEnvBase.html#torchrl.envs.reset) tensordict and the
...
configure_parallel(***, *use_buffers: bool | None = None*, *shared_memory: bool | None = None*, *memmap: bool | None = None*, *mp_start_method: str | None = None*, *num_threads: int | None = None*, *num_sub_threads: int | None = None*, *non_blocking: bool | None = None*, *daemon: bool | None = None*) → EnvBase[[source]](../../_modules/torchrl/envs/common.html#EnvBase.configure_parallel)
...
eager()[[source]](../../_modules/torchrl/envs/common.html#EnvBase.eager)

Restore eager `step_and_maybe_reset()` execution and return `self`.

empty_cache()[[source]](../../_modules/torchrl/envs/common.html#EnvBase.empty_cache)
...
fake_tensordict() → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.fake_tensordict)
...
forward(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.forward)
...
*classmethod*make_parallel(*create_env_fn*, ***, *num_envs: int = 1*, *create_env_kwargs: dict | Sequence[dict] | None = None*, *pin_memory: bool = False*, *share_individual_td: bool | None = None*, *shared_memory: bool = True*, *memmap: bool = False*, *policy_proof: Callable | None = None*, *device: [device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | str | int | None = None*, *allow_step_when_done: bool = False*, *num_threads: int | None = None*, *num_sub_threads: int = 1*, *serial_for_single: bool = False*, *non_blocking: bool = False*, *mp_start_method: str | None = None*, *use_buffers: bool | None = None*, *consolidate: bool = True*, *daemon: bool = False*, ***parallel_kwargs*) → EnvBase[[source]](../../_modules/torchrl/envs/common.html#EnvBase.make_parallel)
...
rand_action(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase) | None = None*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.rand_action)
...
register_collector(*collector: [BaseCollector](torchrl.collectors.BaseCollector.html#torchrl.collectors.BaseCollector)*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.register_collector)
...
reset should not be overwritten by `EnvBase` subclasses. The method to
modify is `_reset()`.
...
set_seed(*seed: int | None = None*, *static_seed: bool = False*) → int | None[[source]](../../_modules/torchrl/envs/common.html#EnvBase.set_seed)
...
set_spec_lock_(*mode: bool = True*) → EnvBase[[source]](../../_modules/torchrl/envs/common.html#EnvBase.set_spec_lock_)
...
step_mdp(*next_tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.step_mdp)
...
to(*device: [device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | str | int*) → EnvBase[[source]](../../_modules/torchrl/envs/common.html#EnvBase.to)

Move and/or cast the parameters and buffers.

This can be called as

to(*device=None*, *dtype=None*, *non_blocking=False*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.to)

to(*dtype*, *non_blocking=False*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.to)

to(*tensor*, *non_blocking=False*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.to)

to(*memory_format=torch.channels_last*)[[source]](../../_modules/torchrl/envs/common.html#EnvBase.to)
