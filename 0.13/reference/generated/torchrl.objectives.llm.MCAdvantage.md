...
*class*torchrl.objectives.llm.MCAdvantage(*grpo_size: int*, *prompt_key: NestedKey = 'query'*, *rewards_key: NestedKey = ('next', 'reward')*, *advantage_key: NestedKey = 'advantage'*, *done_key: NestedKey = ('next', 'done')*, *verbose: bool = False*)[[source]](../../_modules/torchrl/objectives/llm/grpo.html#MCAdvantage)
