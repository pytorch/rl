...
*class*torchrl.envs.llm.transforms.KLComputation(*gen_log_probs_full_key: NestedKey = ('log_probs', 'full')*, *ref_log_probs_full_key: NestedKey = ('ref_log_probs', 'full')*, ***, *kl_key: NestedKey = 'kl_penalty'*, *add_to_reward: bool = True*, *coeff: float = 1.0*, *padding_side: str = 'left'*)[[source]](../../_modules/torchrl/envs/llm/transforms/kl.html#KLComputation)
...
with the [`RetrieveLogProb`](torchrl.envs.llm.transforms.RetrieveLogProb.html#torchrl.envs.llm.transforms.RetrieveLogProb) and [`RetrieveKL`](torchrl.envs.llm.transforms.RetrieveKL.html#torchrl.envs.llm.transforms.RetrieveKL) transforms.
...
transform_observation_spec(*observation_spec: [Composite](torchrl.data.Composite.html#torchrl.data.Composite)*) → [Composite](torchrl.data.Composite.html#torchrl.data.Composite)[[source]](../../_modules/torchrl/envs/llm/transforms/kl.html#KLComputation.transform_observation_spec)
...
transform_reward_spec(*reward_spec: [Composite](torchrl.data.Composite.html#torchrl.data.Composite)*) → [Composite](torchrl.data.Composite.html#torchrl.data.Composite)[[source]](../../_modules/torchrl/envs/llm/transforms/kl.html#KLComputation.transform_reward_spec)
