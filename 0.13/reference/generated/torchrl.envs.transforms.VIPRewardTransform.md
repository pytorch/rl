...
*class*torchrl.envs.transforms.VIPRewardTransform(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/transforms/vip.html#VIPRewardTransform)

A VIP transform to compute rewards based on embedded similarity.

This class will update the reward computation

forward(*tensordict*)[[source]](../../_modules/torchrl/envs/transforms/vip.html#VIPRewardTransform.forward)
...
transform_input_spec(*input_spec: [TensorSpec](torchrl.data.TensorSpec.html#torchrl.data.TensorSpec)*) → [TensorSpec](torchrl.data.TensorSpec.html#torchrl.data.TensorSpec)[[source]](../../_modules/torchrl/envs/transforms/vip.html#VIPRewardTransform.transform_input_spec)
