...
*class*torchrl.envs.SerialEnv(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/batched_envs.html#SerialEnv)
...
This parameter has no effect for the `SerialEnv` class.
...
with a single worker will return a `SerialEnv` instead.
This option has no effect with `SerialEnv`. Defaults to `False`.
...
To be used only with [`ParallelEnv`](torchrl.envs.ParallelEnv.html#torchrl.envs.ParallelEnv) subclasses.
...
This parameter only affects [`ParallelEnv`](torchrl.envs.ParallelEnv.html#torchrl.envs.ParallelEnv).
Defaults to `True`.

Note

For [`ParallelEnv`](torchrl.envs.ParallelEnv.html#torchrl.envs.ParallelEnv), it is recommended to use `functools.partial()`
...
load_state_dict(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/batched_envs.html#SerialEnv.load_state_dict)
...
set_seed(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/batched_envs.html#SerialEnv.set_seed)
...
state_dict(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/batched_envs.html#SerialEnv.state_dict)
...
to(*device: [device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | str | int*)[[source]](../../_modules/torchrl/envs/batched_envs.html#SerialEnv.to)

Move and/or cast the parameters and buffers.

This can be called as

to(*device=None*, *dtype=None*, *non_blocking=False*)[[source]](../../_modules/torchrl/envs/batched_envs.html#SerialEnv.to)

to(*dtype*, *non_blocking=False*)[[source]](../../_modules/torchrl/envs/batched_envs.html#SerialEnv.to)

to(*tensor*, *non_blocking=False*)[[source]](../../_modules/torchrl/envs/batched_envs.html#SerialEnv.to)

to(*memory_format=torch.channels_last*)[[source]](../../_modules/torchrl/envs/batched_envs.html#SerialEnv.to)
