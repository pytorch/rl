...
*class*torchrl.envs.llm.transforms.PolicyVersion(*version_type: type | ~typing.Literal['uuid'*, *'int'] = <class 'int'>*)[[source]](../../_modules/torchrl/envs/llm/transforms/policy_version.html#PolicyVersion)
...
[`LLMCollector`](torchrl.collectors.llm.LLMCollector.html#torchrl.collectors.llm.LLMCollector) to ensure data collection and training remain in sync.

The version can be either a UUID (string) or an integer counter. When used with [`LLMCollector`](torchrl.collectors.llm.LLMCollector.html#torchrl.collectors.llm.LLMCollector),
the version is automatically incremented each time the policy weights are updated.

Example usage with [`LLMCollector`](torchrl.collectors.llm.LLMCollector.html#torchrl.collectors.llm.LLMCollector):
...
increment_version() → None[[source]](../../_modules/torchrl/envs/llm/transforms/policy_version.html#PolicyVersion.increment_version)
...
transform_observation_spec(*spec: [Composite](torchrl.data.Composite.html#torchrl.data.Composite)*) → [Composite](torchrl.data.Composite.html#torchrl.data.Composite)[[source]](../../_modules/torchrl/envs/llm/transforms/policy_version.html#PolicyVersion.transform_observation_spec)
