...
- **collector_class** (*Type**or**str**,**optional*) -
...
Support for `MultiSyncCollector` and `MultiAsyncCollector`
is experimental, and [`Collector`](torchrl.collectors.Collector.html#torchrl.collectors.Collector)
should always be preferred. If multiple simultaneous environment
need to be executed on a single node, consider using a
[`ParallelEnv`](torchrl.envs.ParallelEnv.html#torchrl.envs.ParallelEnv) instance.
...
through
[`update_policy_weights_()`](torchrl.collectors.distributed.DistributedCollector.html#torchrl.collectors.distributed.DistributedCollector.update_policy_weights_).
...
- **visible_devices** ([*list*](torchrl.services.RayService.html#torchrl.services.RayService.list)*of**Union**[**int**,*[*torch.device*](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device)*,**str**]**,**optional*) - a
...
to pass to `torch.distributed.rpc.TensorPipeRpcBackendOption`.
...
If not provided, an [`RPCWeightUpdater`](torchrl.collectors.distributed.RPCWeightUpdater.html#torchrl.collectors.distributed.RPCWeightUpdater) will be used by default, which
...
If not provided, an [`RPCWeightSyncScheme`](torchrl.weight_update.RPCWeightSyncScheme.html#torchrl.weight_update.RPCWeightSyncScheme) will be used by default.
