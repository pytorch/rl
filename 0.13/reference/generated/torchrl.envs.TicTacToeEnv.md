...
*class*torchrl.envs.TicTacToeEnv(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/custom/tictactoeenv.html#TicTacToeEnv)
...
- **device** ([*torch.device*](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device)*,**optional*) - the device where to put the tensors.
...
rand_action(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase) | None = None*)[[source]](../../_modules/torchrl/envs/custom/tictactoeenv.html#TicTacToeEnv.rand_action)
