...
*class*torchrl.envs.HumanoidEnv(**args*, *num_workers: int = 1*, *parallel: bool | None = None*, ***kwargs*)[[source]](../../_modules/torchrl/envs/custom/mujoco/humanoid.html#HumanoidEnv)
...
make_control_transform(***, *execute: bool = True*, *multi_action_dim: int = 1*, *stack_rewards: bool = True*, *stack_observations: bool = False*, *macro_steps: int = 16*, *settle_steps: int = 0*) → [Transform](torchrl.envs.transforms.Transform.html#torchrl.envs.transforms.Transform)[[source]](../../_modules/torchrl/envs/custom/mujoco/humanoid.html#HumanoidEnv.make_control_transform)
...
>>> from torchrl.envs import HumanoidEnv 
>>> env = HumanoidEnv() 
>>> transform = env.make_control_transform(execute=True)
```
