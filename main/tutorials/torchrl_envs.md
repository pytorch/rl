...
```
<matplotlib.image.AxesImage object at 0x7fae14af1a50>
```
...
```
'bar_ec5969e6-7b6e-11f1-a02e-0242ac110002'
```
...
```
<torchrl.envs.batched_envs._dispatch_caller_parallel object at 0x7fadf93efad0>
```
...
```
['bar_eded1c62-7b6e-11f1-a226-0242ac110002', 'bar_edece0e4-7b6e-11f1-910d-0242ac110002', 'bar_edf677da-7b6e-11f1-be9f-0242ac110002']
```
...
```
mean: : tensor([-0.3069, -0.0298, -0.1531])
std: : tensor([1.0509, 1.2347, 1.1940])
```
...
data: TensorDict(
 ...
 device=None,
 is_shared=False)
mean: : tensor([-0.2593, 0.0537, 0.0098])
std: : tensor([0.9788, 1.1660, 1.1088])
```
...
**Total running time of the script:** (0 minutes 24.966 seconds)
