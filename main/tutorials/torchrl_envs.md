...
```
<matplotlib.image.AxesImage object at 0x7fea553d6f10>
```
...
```
'bar_01c3756a-b32d-11f1-b51f-0242ac110002'
```
...
```
<torchrl.envs.batched_envs._dispatch_caller_parallel object at 0x7fea27c68150>
```
...
```
['bar_0350617c-b32d-11f1-9dda-0242ac110002', 'bar_0346d5ee-b32d-11f1-b61f-0242ac110002', 'bar_035251da-b32d-11f1-a683-0242ac110002']
```
...
```
mean: : tensor([ 0.8168, -0.4509, 0.0349])
std: : tensor([1.5482, 1.6414, 1.5104])
```
...
data: TensorDict(
 ...
 device=None,
 is_shared=False)
mean: : tensor([-0.1835, 0.0911, 0.0666])
std: : tensor([1.0493, 1.2106, 1.1072])
```
