...
```
<matplotlib.image.AxesImage object at 0x7fb749350190>
```
...
```
'bar_edaeb660-b008-11f1-a69c-0242ac110002'
```
...
```
<torchrl.envs.batched_envs._dispatch_caller_parallel object at 0x7fb74b3cfc10>
```
...
```
['bar_ef443f40-b008-11f1-91bd-0242ac110002', 'bar_ef47348e-b008-11f1-ac8d-0242ac110002', 'bar_ef3e32da-b008-11f1-9d7d-0242ac110002']
```
...
```
mean: : tensor([-0.0091, 0.1420, -0.1032])
std: : tensor([1.1213, 1.1191, 1.0781])
```
...
data: TensorDict(
 ...
 device=None,
 is_shared=False)
mean: : tensor([-0.1054, -0.0171, 0.0933])
std: : tensor([1.0257, 1.2499, 1.0950])
```
