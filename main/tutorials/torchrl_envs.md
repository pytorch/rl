...
```
<matplotlib.image.AxesImage object at 0x7fb95cae5ed0>
```
...
```
'bar_f1b5f668-64b0-11f1-b1e9-0242ac110002'
```
...
```
<torchrl.envs.batched_envs._dispatch_caller_parallel object at 0x7fb95cc8ff10>
```
...
```
['bar_f3406ac2-64b0-11f1-a73f-0242ac110002', 'bar_f3481aba-64b0-11f1-8091-0242ac110002', 'bar_f33f859e-64b0-11f1-94d6-0242ac110002']
```
...
```
mean: : tensor([1.0308, 0.1852, 0.3240])
std: : tensor([1.4876, 1.7197, 1.5746])
```
...
data: TensorDict(
 ...
 device=None,
 is_shared=False)
mean: : tensor([-0.2966, 0.1339, -0.1114])
std: : tensor([1.2605, 1.1689, 1.3100])
```
