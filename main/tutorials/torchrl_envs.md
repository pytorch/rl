...
```
<matplotlib.image.AxesImage object at 0x7f3367a01f50>
```
...
```
'bar_3e1a2806-af36-11f1-a015-0242ac110002'
```
...
```
<torchrl.envs.batched_envs._dispatch_caller_parallel object at 0x7f3365097250>
```
...
```
['bar_3fa4a82c-af36-11f1-90fa-0242ac110002', 'bar_3fa3ddd4-af36-11f1-ab12-0242ac110002', 'bar_3fa4b880-af36-11f1-ace4-0242ac110002']
```
...
```
mean: : tensor([ 0.1032, -0.2209, -0.0424])
std: : tensor([1.2477, 1.1547, 1.2273])
```
...
data: TensorDict(
 ...
 device=None,
 is_shared=False)
mean: : tensor([-0.2157, 0.0117, 0.1398])
std: : tensor([1.0592, 1.2774, 1.1257])
```
...
**Total running time of the script:** (0 minutes 24.723 seconds)
