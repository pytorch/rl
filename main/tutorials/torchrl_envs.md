...
```
<matplotlib.image.AxesImage object at 0x7fc22cb9ab50>
```
...
```
'bar_60e79d74-7b73-11f1-a91d-0242ac110002'
```
...
```
<torchrl.envs.batched_envs._dispatch_caller_parallel object at 0x7fc22ed85690>
```
...
```
['bar_62774874-7b73-11f1-abb0-0242ac110002', 'bar_62764e60-7b73-11f1-846e-0242ac110002', 'bar_6271aa9a-7b73-11f1-9399-0242ac110002']
```
...
```
mean: : tensor([-0.2686, -0.0366, -0.1963])
std: : tensor([1.0518, 1.2049, 1.1901])
```
...
data: TensorDict(
 ...
 device=None,
 is_shared=False)
mean: : tensor([-0.0560, -0.0071, 0.1584])
std: : tensor([1.2186, 1.2403, 1.1390])
```
