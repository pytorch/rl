...
```
<matplotlib.image.AxesImage object at 0x7f4e20198210>
```
...
```
'bar_4e60a3a0-9b2e-11f1-a04a-0242ac110002'
```
...
```
<torchrl.envs.batched_envs._dispatch_caller_parallel object at 0x7f4e1bdeb150>
```
...
```
['bar_4ff9112a-9b2e-11f1-9f45-0242ac110002', 'bar_4ffe6076-9b2e-11f1-8127-0242ac110002', 'bar_5000f1ce-9b2e-11f1-856b-0242ac110002']
```
...
```
mean: : tensor([-0.3534, 0.3249, 0.1897])
std: : tensor([0.9198, 1.0469, 1.1014])
```
...
data: TensorDict(
 ...
 device=None,
 is_shared=False)
mean: : tensor([-0.1517, 0.1098, 0.1801])
std: : tensor([1.1510, 1.1562, 1.0405])
```
...
**Total running time of the script:** (0 minutes 25.410 seconds)
