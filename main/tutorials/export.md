...
```
pkg_path /tmp/tmpgdp1khjd/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 621.6037 msec (total = 0.6216 sec since last reset).
TorchRL version took 2036.5756 msec (total = 2.0366 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.138 seconds)
