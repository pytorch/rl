...
```
pkg_path /tmp/tmpjysop7mc/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 637.3882 msec (total = 0.6374 sec since last reset).
TorchRL version took 2133.7211 msec (total = 2.1337 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.088 seconds)
