...
```
pkg_path /tmp/tmpnn7ojrhn/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 629.0622 msec (total = 0.6291 sec since last reset).
TorchRL version took 2028.6462 msec (total = 2.0286 sec since last reset).
```
