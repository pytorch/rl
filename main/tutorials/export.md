...
```
pkg_path /tmp/tmpypwfcyny/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 618.8879 msec (total = 0.6189 sec since last reset).
TorchRL version took 1840.9650 msec (total = 1.8410 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 22.920 seconds)
