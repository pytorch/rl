...
```
pkg_path /tmp/tmpexbze9wj/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 615.2375 msec (total = 0.6152 sec since last reset).
TorchRL version took 1864.6998 msec (total = 1.8647 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.459 seconds)
