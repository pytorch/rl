...
```
pkg_path /tmp/tmpnuv_lakm/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 615.6569 msec (total = 0.6157 sec since last reset).
TorchRL version took 1818.7203 msec (total = 1.8187 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.493 seconds)
