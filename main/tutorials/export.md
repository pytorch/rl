...
```
pkg_path /tmp/tmpzovkrsf9/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 620.9621 msec (total = 0.6210 sec since last reset).
TorchRL version took 1810.2643 msec (total = 1.8103 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.106 seconds)
