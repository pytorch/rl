...
```
pkg_path /tmp/tmpjmf5c2mm/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 628.7177 msec (total = 0.6287 sec since last reset).
TorchRL version took 1877.5249 msec (total = 1.8775 sec since last reset).
```
