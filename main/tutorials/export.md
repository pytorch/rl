...
```
pkg_path /tmp/tmp9ogs3bw3/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 688.0555 msec (total = 0.6881 sec since last reset).
TorchRL version took 2058.5091 msec (total = 2.0585 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.232 seconds)
