...
```
pkg_path /tmp/tmpkqmynd8v/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 625.2604 msec (total = 0.6253 sec since last reset).
TorchRL version took 1855.7055 msec (total = 1.8557 sec since last reset).
```
