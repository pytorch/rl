...
```
pkg_path /tmp/tmp2yntwh_9/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 633.4190 msec (total = 0.6334 sec since last reset).
TorchRL version took 2029.0060 msec (total = 2.0290 sec since last reset).
```
