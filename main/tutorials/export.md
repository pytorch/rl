...
```
pkg_path /tmp/tmp6wid6m2t/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 633.5139 msec (total = 0.6335 sec since last reset).
TorchRL version took 2066.1592 msec (total = 2.0662 sec since last reset).
```
