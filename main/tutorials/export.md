...
```
pkg_path /tmp/tmpowz94lf_/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 619.9243 msec (total = 0.6199 sec since last reset).
TorchRL version took 2057.0381 msec (total = 2.0570 sec since last reset).
```
