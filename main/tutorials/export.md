...
```
pkg_path /tmp/tmpo1jp_e0h/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 616.0741 msec (total = 0.6161 sec since last reset).
TorchRL version took 2059.7618 msec (total = 2.0598 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.262 seconds)
