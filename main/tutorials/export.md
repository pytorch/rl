...
```
pkg_path /tmp/tmpl_qgdzm1/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 625.3142 msec (total = 0.6253 sec since last reset).
TorchRL version took 2050.9782 msec (total = 2.0510 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.231 seconds)
