...
```
pkg_path /tmp/tmposi0zqjz/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 618.1304 msec (total = 0.6181 sec since last reset).
TorchRL version took 1803.2913 msec (total = 1.8033 sec since last reset).
```
