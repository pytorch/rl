...
```
pkg_path /tmp/tmptuy15j4p/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 615.0217 msec (total = 0.6150 sec since last reset).
TorchRL version took 2017.0548 msec (total = 2.0171 sec since last reset).
```
