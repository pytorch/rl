...
```
pkg_path /tmp/tmp6345n7rw/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 623.5588 msec (total = 0.6236 sec since last reset).
TorchRL version took 1730.9732 msec (total = 1.7310 sec since last reset).
```
