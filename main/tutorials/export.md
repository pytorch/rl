...
```
pkg_path /tmp/tmpuiywrpq8/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 642.1697 msec (total = 0.6422 sec since last reset).
TorchRL version took 2013.4108 msec (total = 2.0134 sec since last reset).
```
