...
```
pkg_path /tmp/tmppognp0_u/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 629.8454 msec (total = 0.6298 sec since last reset).
TorchRL version took 2042.8014 msec (total = 2.0428 sec since last reset).
```
