...
```
pkg_path /tmp/tmp0elag_l0/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 623.1174 msec (total = 0.6231 sec since last reset).
TorchRL version took 2063.6787 msec (total = 2.0637 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.505 seconds)
