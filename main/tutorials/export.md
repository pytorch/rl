...
```
pkg_path /tmp/tmpxez7ci2n/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 634.2616 msec (total = 0.6343 sec since last reset).
TorchRL version took 2043.2591 msec (total = 2.0433 sec since last reset).
```
