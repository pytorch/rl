...
```
pkg_path /tmp/tmplicym2je/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 636.9891 msec (total = 0.6370 sec since last reset).
TorchRL version took 1807.0550 msec (total = 1.8071 sec since last reset).
```
