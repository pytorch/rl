...
```
pkg_path /tmp/tmpa2xsqpry/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 619.2396 msec (total = 0.6192 sec since last reset).
TorchRL version took 2020.2565 msec (total = 2.0203 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 22.975 seconds)
