...
```
pkg_path /tmp/tmpdr0e3qmi/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 621.7468 msec (total = 0.6217 sec since last reset).
TorchRL version took 2082.1848 msec (total = 2.0822 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.322 seconds)
