...
```
pkg_path /tmp/tmpkegni8gl/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 621.3186 msec (total = 0.6213 sec since last reset).
TorchRL version took 1863.2870 msec (total = 1.8633 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.510 seconds)
