...
```
pkg_path /tmp/tmp4841_cv9/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 634.8617 msec (total = 0.6349 sec since last reset).
TorchRL version took 2021.9259 msec (total = 2.0219 sec since last reset).
```
