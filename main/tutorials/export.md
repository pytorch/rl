...
```
pkg_path /tmp/tmpy_20fg6t/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 619.0946 msec (total = 0.6191 sec since last reset).
TorchRL version took 2107.4708 msec (total = 2.1075 sec since last reset).
```
