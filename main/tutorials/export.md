...
```
pkg_path /tmp/tmp7bpk246d/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 624.6173 msec (total = 0.6246 sec since last reset).
TorchRL version took 2123.5671 msec (total = 2.1236 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.386 seconds)
