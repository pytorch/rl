...
```
pkg_path /tmp/tmpxnb8_yi2/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 629.4889 msec (total = 0.6295 sec since last reset).
TorchRL version took 2072.9678 msec (total = 2.0730 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.210 seconds)
