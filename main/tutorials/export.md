...
```
pkg_path /tmp/tmp4_hutz13/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 630.8417 msec (total = 0.6308 sec since last reset).
TorchRL version took 1978.9126 msec (total = 1.9789 sec since last reset).
```
