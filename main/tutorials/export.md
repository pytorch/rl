...
```
pkg_path /tmp/tmpfbz8c2uj/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 646.9035 msec (total = 0.6469 sec since last reset).
TorchRL version took 2066.4144 msec (total = 2.0664 sec since last reset).
```
