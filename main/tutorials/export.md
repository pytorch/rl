...
```
pkg_path /tmp/tmp36773hin/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 629.4942 msec (total = 0.6295 sec since last reset).
TorchRL version took 2084.5199 msec (total = 2.0845 sec since last reset).
```
