...
```
pkg_path /tmp/tmp4zzau7mw/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 640.4300 msec (total = 0.6404 sec since last reset).
TorchRL version took 2038.8994 msec (total = 2.0389 sec since last reset).
```
