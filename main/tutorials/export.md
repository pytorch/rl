...
```
pkg_path /tmp/tmphdetoccf/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 623.6250 msec (total = 0.6236 sec since last reset).
TorchRL version took 2058.8255 msec (total = 2.0588 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.396 seconds)
