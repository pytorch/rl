...
```
pkg_path /tmp/tmpbrcv4fuw/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 623.8425 msec (total = 0.6238 sec since last reset).
TorchRL version took 2045.1422 msec (total = 2.0451 sec since last reset).
```
