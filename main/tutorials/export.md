...
```
pkg_path /tmp/tmpps7_9i0l/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 618.8900 msec (total = 0.6189 sec since last reset).
TorchRL version took 2083.0672 msec (total = 2.0831 sec since last reset).
```
