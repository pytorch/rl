...
```
pkg_path /tmp/tmpc4a4evxz/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 623.6744 msec (total = 0.6237 sec since last reset).
TorchRL version took 2111.4683 msec (total = 2.1115 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.416 seconds)
