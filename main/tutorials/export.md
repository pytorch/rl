...
```
pkg_path /tmp/tmps_znlanx/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 611.8431 msec (total = 0.6118 sec since last reset).
TorchRL version took 1885.1690 msec (total = 1.8852 sec since last reset).
```
