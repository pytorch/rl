...
```
pkg_path /tmp/tmpv31ko4_2/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 630.4109 msec (total = 0.6304 sec since last reset).
TorchRL version took 2115.7517 msec (total = 2.1158 sec since last reset).
```
