...
```
pkg_path /tmp/tmpzojfjfoc/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 630.9178 msec (total = 0.6309 sec since last reset).
TorchRL version took 2073.9970 msec (total = 2.0740 sec since last reset).
```
