...
```
pkg_path /tmp/tmp59ghvzvz/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 611.3048 msec (total = 0.6113 sec since last reset).
TorchRL version took 1996.6292 msec (total = 1.9966 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.164 seconds)
