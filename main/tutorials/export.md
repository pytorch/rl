...
```
pkg_path /tmp/tmpwtv8b0in/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 622.7393 msec (total = 0.6227 sec since last reset).
TorchRL version took 1799.2544 msec (total = 1.7993 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.241 seconds)
