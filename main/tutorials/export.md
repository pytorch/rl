...
```
pkg_path /tmp/tmpspq5tcv4/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 624.3234 msec (total = 0.6243 sec since last reset).
TorchRL version took 2071.7041 msec (total = 2.0717 sec since last reset).
```
