...
```
pkg_path /tmp/tmpnxx_lkbq/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 620.1332 msec (total = 0.6201 sec since last reset).
TorchRL version took 2051.3959 msec (total = 2.0514 sec since last reset).
```
