...
```
pkg_path /tmp/tmpyjiykek3/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 621.8724 msec (total = 0.6219 sec since last reset).
TorchRL version took 2104.7935 msec (total = 2.1048 sec since last reset).
```
