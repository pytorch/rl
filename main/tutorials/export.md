...
```
pkg_path /tmp/tmpqm0mzlpu/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 640.3372 msec (total = 0.6403 sec since last reset).
TorchRL version took 2079.2007 msec (total = 2.0792 sec since last reset).
```
