...
```
pkg_path /tmp/tmpeu2mhle0/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 620.5499 msec (total = 0.6205 sec since last reset).
TorchRL version took 2149.6823 msec (total = 2.1497 sec since last reset).
```
