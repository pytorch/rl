...
```
pkg_path /tmp/tmp4swxe8xo/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 616.2121 msec (total = 0.6162 sec since last reset).
TorchRL version took 2019.7465 msec (total = 2.0197 sec since last reset).
```
