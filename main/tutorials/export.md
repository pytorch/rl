...
```
pkg_path /tmp/tmp5aw6qv0t/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 631.8390 msec (total = 0.6318 sec since last reset).
TorchRL version took 2031.0345 msec (total = 2.0310 sec since last reset).
```
