...
```
pkg_path /tmp/tmpdm8f1cs_/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 619.4358 msec (total = 0.6194 sec since last reset).
TorchRL version took 1774.5986 msec (total = 1.7746 sec since last reset).
```
