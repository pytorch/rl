...
```
pkg_path /tmp/tmp1muojssg/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 637.6133 msec (total = 0.6376 sec since last reset).
TorchRL version took 1854.9058 msec (total = 1.8549 sec since last reset).
```
