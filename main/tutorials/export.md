...
```
pkg_path /tmp/tmpc_e43jz7/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 624.8460 msec (total = 0.6248 sec since last reset).
TorchRL version took 2067.2433 msec (total = 2.0672 sec since last reset).
```
