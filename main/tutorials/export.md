...
```
pkg_path /tmp/tmpm85o6hdf/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 623.5161 msec (total = 0.6235 sec since last reset).
TorchRL version took 2056.7942 msec (total = 2.0568 sec since last reset).
```
