...
```
pkg_path /tmp/tmpyt0c1lfx/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 631.5100 msec (total = 0.6315 sec since last reset).
TorchRL version took 2094.8977 msec (total = 2.0949 sec since last reset).
```
