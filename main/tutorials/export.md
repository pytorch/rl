...
```
pkg_path /tmp/tmp_jil_8b5/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 621.7132 msec (total = 0.6217 sec since last reset).
TorchRL version took 1910.0335 msec (total = 1.9100 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.526 seconds)
