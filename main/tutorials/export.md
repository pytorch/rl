...
```
pkg_path /tmp/tmpcwokqpi0/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 620.0225 msec (total = 0.6200 sec since last reset).
TorchRL version took 1824.3997 msec (total = 1.8244 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.099 seconds)
