...
```
pkg_path /tmp/tmpjs382g2r/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 623.2371 msec (total = 0.6232 sec since last reset).
TorchRL version took 2027.4887 msec (total = 2.0275 sec since last reset).
```
