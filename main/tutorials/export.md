...
```
pkg_path /tmp/tmp6akcdmg6/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 619.1010 msec (total = 0.6191 sec since last reset).
TorchRL version took 1843.8337 msec (total = 1.8438 sec since last reset).
```
