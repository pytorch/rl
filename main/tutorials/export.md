...
```
pkg_path /tmp/tmpdto628xf/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 635.5295 msec (total = 0.6355 sec since last reset).
TorchRL version took 1734.4820 msec (total = 1.7345 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 22.934 seconds)
