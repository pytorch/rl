...
```
pkg_path /tmp/tmpwtdp_86g/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 628.0265 msec (total = 0.6280 sec since last reset).
TorchRL version took 2043.5455 msec (total = 2.0435 sec since last reset).
```
