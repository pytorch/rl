...
```
pkg_path /tmp/tmptjpmath1/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 621.2626 msec (total = 0.6213 sec since last reset).
TorchRL version took 2072.8214 msec (total = 2.0728 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.242 seconds)
