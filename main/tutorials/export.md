...
```
pkg_path /tmp/tmp5fpidmbg/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 614.5172 msec (total = 0.6145 sec since last reset).
TorchRL version took 1728.6575 msec (total = 1.7287 sec since last reset).
```
