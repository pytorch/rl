...
```
pkg_path /tmp/tmpxezeqdvm/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 621.3996 msec (total = 0.6214 sec since last reset).
TorchRL version took 2110.8298 msec (total = 2.1108 sec since last reset).
```
