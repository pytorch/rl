...
```
pkg_path /tmp/tmpn4uzvi5b/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 625.6070 msec (total = 0.6256 sec since last reset).
TorchRL version took 2077.9481 msec (total = 2.0779 sec since last reset).
```
