...
```
pkg_path /tmp/tmp_apb0y2d/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 624.4266 msec (total = 0.6244 sec since last reset).
TorchRL version took 2091.7218 msec (total = 2.0917 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.337 seconds)
