...
```
pkg_path /tmp/tmph1dy36if/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 620.4236 msec (total = 0.6204 sec since last reset).
TorchRL version took 2005.1398 msec (total = 2.0051 sec since last reset).
```
