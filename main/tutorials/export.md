...
```
pkg_path /tmp/tmpt2ceozss/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 621.9392 msec (total = 0.6219 sec since last reset).
TorchRL version took 2092.4151 msec (total = 2.0924 sec since last reset).
```
