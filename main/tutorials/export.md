...
```
pkg_path /tmp/tmpcfsxx5lw/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 613.2731 msec (total = 0.6133 sec since last reset).
TorchRL version took 2043.3946 msec (total = 2.0434 sec since last reset).
```
