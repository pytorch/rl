...
class GraphModule(torch.nn.Module):
 ...
 # File: /pytorch/rl/torchrl/modules/tensordict_module/actors.py:858 in forward, code: action = self.action_func_mapping[self.action_space](action_values)
 ...
 # File: /pytorch/rl/torchrl/modules/tensordict_module/actors.py:863 in forward, code: chosen_action_value = action_value_func(action_values, action)
...
```
pkg_path /tmp/tmpf3ui9rb5/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 603.5070 msec (total = 0.6035 sec since last reset).
TorchRL version took 1836.5738 msec (total = 1.8366 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.000 seconds)
