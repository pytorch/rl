...
```
pkg_path /tmp/tmp9buzcfis/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 621.3942 msec (total = 0.6214 sec since last reset).
TorchRL version took 1920.0387 msec (total = 1.9200 sec since last reset).
```
