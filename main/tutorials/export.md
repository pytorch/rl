...
```
pkg_path /tmp/tmpw9dum5yl/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 789.3941 msec (total = 0.7894 sec since last reset).
TorchRL version took 2199.9567 msec (total = 2.2000 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.551 seconds)
