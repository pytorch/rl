...
```
pkg_path /tmp/tmpo90hv4ge/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 627.2886 msec (total = 0.6273 sec since last reset).
TorchRL version took 2022.1839 msec (total = 2.0222 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.154 seconds)
