...
```
pkg_path /tmp/tmpee1uq0en/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 671.0818 msec (total = 0.6711 sec since last reset).
TorchRL version took 2057.2777 msec (total = 2.0573 sec since last reset).
```
