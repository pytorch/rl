...
```
pkg_path /tmp/tmp3ciskzxp/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 630.2080 msec (total = 0.6302 sec since last reset).
TorchRL version took 1770.9129 msec (total = 1.7709 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.020 seconds)
