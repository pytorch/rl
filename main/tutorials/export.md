...
```
pkg_path /tmp/tmpwuzcbze3/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 626.6363 msec (total = 0.6266 sec since last reset).
TorchRL version took 2027.5145 msec (total = 2.0275 sec since last reset).
```
