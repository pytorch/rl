...
```
pkg_path /tmp/tmp44c2jhp6/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 624.5508 msec (total = 0.6246 sec since last reset).
TorchRL version took 2135.3998 msec (total = 2.1354 sec since last reset).
```
