...
```
pkg_path /tmp/tmptz11nnv4/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 622.1664 msec (total = 0.6222 sec since last reset).
TorchRL version took 2056.4599 msec (total = 2.0565 sec since last reset).
```
