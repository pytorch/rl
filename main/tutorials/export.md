...
```
pkg_path /tmp/tmpm3h33py4/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 616.5841 msec (total = 0.6166 sec since last reset).
TorchRL version took 2074.0061 msec (total = 2.0740 sec since last reset).
```
