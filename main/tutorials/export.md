...
```
pkg_path /tmp/tmpr6knj6fd/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 623.0421 msec (total = 0.6230 sec since last reset).
TorchRL version took 2079.6804 msec (total = 2.0797 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.499 seconds)
