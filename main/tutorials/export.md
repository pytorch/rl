...
```
pkg_path /tmp/tmphzhgf320/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 631.0756 msec (total = 0.6311 sec since last reset).
TorchRL version took 2029.8023 msec (total = 2.0298 sec since last reset).
```
