...
```
pkg_path /tmp/tmpzxi570ue/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 615.6392 msec (total = 0.6156 sec since last reset).
TorchRL version took 2095.9549 msec (total = 2.0960 sec since last reset).
```
