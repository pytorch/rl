...
```
pkg_path /tmp/tmpd46bo6tq/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 624.2964 msec (total = 0.6243 sec since last reset).
TorchRL version took 1856.6265 msec (total = 1.8566 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 22.969 seconds)
