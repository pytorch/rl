...
```
pkg_path /tmp/tmplme160ob/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 634.4500 msec (total = 0.6344 sec since last reset).
TorchRL version took 2126.7645 msec (total = 2.1268 sec since last reset).
```
