...
```
pkg_path /tmp/tmpfn74ilff/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 629.7755 msec (total = 0.6298 sec since last reset).
TorchRL version took 2107.3177 msec (total = 2.1073 sec since last reset).
```
