...
```
pkg_path /tmp/tmp4v71382b/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 640.6262 msec (total = 0.6406 sec since last reset).
TorchRL version took 1946.7225 msec (total = 1.9467 sec since last reset).
```
