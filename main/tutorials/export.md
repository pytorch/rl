...
```
pkg_path /tmp/tmpz0eupvke/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 629.5094 msec (total = 0.6295 sec since last reset).
TorchRL version took 2113.7199 msec (total = 2.1137 sec since last reset).
```
