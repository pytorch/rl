...
```
pkg_path /tmp/tmpcfrr7s2b/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 628.6573 msec (total = 0.6287 sec since last reset).
TorchRL version took 2088.8195 msec (total = 2.0888 sec since last reset).
```
