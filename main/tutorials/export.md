...
```
pkg_path /tmp/tmpwsfc2o4u/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 625.3061 msec (total = 0.6253 sec since last reset).
TorchRL version took 1920.7189 msec (total = 1.9207 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.096 seconds)
