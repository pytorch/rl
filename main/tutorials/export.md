...
```
pkg_path /tmp/tmp9ad1nf_s/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 621.8059 msec (total = 0.6218 sec since last reset).
TorchRL version took 2009.9721 msec (total = 2.0100 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.128 seconds)
