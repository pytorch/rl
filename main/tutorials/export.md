...
```
pkg_path /tmp/tmp1tqefcd_/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 643.7423 msec (total = 0.6437 sec since last reset).
TorchRL version took 2065.4225 msec (total = 2.0654 sec since last reset).
```
