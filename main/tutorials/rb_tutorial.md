...
```
The buffer has 3 elements
the 'a' tensor is stored in /tmp/tmp8t1uw7td/a.memmap
the ('b', 'c') tensor is stored in /tmp/tmp8t1uw7td/b/c.memmap
...
```
tensor([2, 2, 0, 1, 1, 0, 0, 0, 1, 2, 1, 2])
```
...
```
['foo', 'foo', None, 'foo', 'foo', 'foo', 'foo', 'foo', 'foo', 'foo']
```
...
```
{'priority_weight': tensor([2.0893e-10, 2.0893e-10, 6.9183e-07, 2.0893e-10, 2.0893e-10, 2.0893e-10,
 2.0893e-10, 2.0893e-10, 2.0893e-10, 2.0893e-10]), 'index': tensor([1, 1, 2, 1, 1, 1, 1, 1, 1, 1])}
```
...
```
episode are grouped tensor([4, 4, 3, 3, 3, 3, 3, 3], dtype=torch.int32)
