...
```
The buffer has 3 elements
the 'a' tensor is stored in /tmp/tmppelsfx88/a.memmap
the ('b', 'c') tensor is stored in /tmp/tmppelsfx88/b/c.memmap
...
```
tensor([0, 1, 1, 0, 0, 0, 1, 2, 1, 2, 1, 2])
```
...
```
episode are grouped tensor([3, 3, 3, 3, 3, 3, 2, 2], dtype=torch.int32)
