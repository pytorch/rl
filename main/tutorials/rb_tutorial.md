...
```
The buffer has 3 elements
the 'a' tensor is stored in /tmp/tmpfy0as9k3/a.memmap
the ('b', 'c') tensor is stored in /tmp/tmpfy0as9k3/b/c.memmap
...
```
tensor([1, 0, 0, 2, 0, 2, 2, 1, 1, 0, 1, 0])
```
...
```
episode are grouped tensor([4, 4, 1, 1, 1, 1, 4, 4], dtype=torch.int32)
steps are successive tensor([1, 2, 1, 2, 0, 1, 1, 2])
