...
```
The buffer has 3 elements
the 'a' tensor is stored in /tmp/tmpckqf_ck2/a.memmap
the ('b', 'c') tensor is stored in /tmp/tmpckqf_ck2/b/c.memmap
...
```
tensor([0, 2, 2, 2, 0, 1, 1, 0, 0, 0, 1, 2])
```
...
```
episode are grouped tensor([4, 4, 3, 3, 4, 4, 3, 3], dtype=torch.int32)
