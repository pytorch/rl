...
```
Collected 115 steps, total reward: 115
```
...
Collected batch: torch.Size([200]), reward: -7.06
Collected batch: torch.Size([200]), reward: -6.98
```
...
```
Prioritized sample indices: tensor([31, 92, 48, 78, 50]) ...
```
