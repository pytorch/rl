...
```
Collected batch: torch.Size([200]), reward: -6.27
Collected batch: torch.Size([200]), reward: -5.88
Collected batch: torch.Size([200]), reward: -9.03
Collected batch: torch.Size([200]), reward: -7.20
Collected batch: torch.Size([200]), reward: -8.80
```
...
```
Prioritized sample indices: tensor([76, 12, 77, 1, 11]) ...
```
