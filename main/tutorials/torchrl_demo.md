...
```
Collected 105 steps, total reward: 105
```
...
Collected batch: torch.Size([200]), reward: -6.63
Collected batch: torch.Size([200]), reward: -5.61
Collected batch: torch.Size([200]), reward: -6.11
```
...
```
Prioritized sample indices: tensor([ 5, 44, 40, 48, 83]) ...
```
