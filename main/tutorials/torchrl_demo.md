...
```
Collected batch: torch.Size([200]), reward: -8.32
Collected batch: torch.Size([200]), reward: -9.08
Collected batch: torch.Size([200]), reward: -8.54
Collected batch: torch.Size([200]), reward: -8.92
...
```
Prioritized sample indices: tensor([23, 18, 21, 56, 13]) ...
```
