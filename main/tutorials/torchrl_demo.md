...
Collected batch: torch.Size([200]), reward: -7.26
Collected batch: torch.Size([200]), reward: -5.68
Collected batch: torch.Size([200]), reward: -5.74
...
```
Prioritized sample indices: tensor([65, 0, 66, 63, 47]) ...
```
