...
Collected batch: torch.Size([200]), reward: -6.66
Collected batch: torch.Size([200]), reward: -5.10
Collected batch: torch.Size([200]), reward: -6.70
Collected batch: torch.Size([200]), reward: -6.42
```
...
```
Prioritized sample indices: tensor([ 8, 80, 96, 44, 54]) ...
```
