...
[`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler), value estimators in
...
[`InitTracker`](generated/torchrl.envs.transforms.InitTracker.html#torchrl.envs.transforms.InitTracker) at every reset, and
additionally written by
[`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler) at the start of every
...
[`GRUModule`](generated/torchrl.modules.GRUModule.html#torchrl.modules.GRUModule)) split on under
[`set_recurrent_mode`](generated/torchrl.modules.set_recurrent_mode.html#torchrl.modules.set_recurrent_mode) `("recurrent")`: each
...
`truncated` (TorchRL's
[`EnvBase`](generated/torchrl.envs.EnvBase.html#torchrl.envs.EnvBase) metaclass guarantees both are flanked
with their dual). Used by collectors to decide when to reset, by
[`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler) to reconstruct trajectory boundaries
when no `traj_ids` key is available, and by
[`split_trajectories()`](generated/torchrl.collectors.utils.split_trajectories.html#torchrl.collectors.utils.split_trajectories) (legacy).
...
[`DEFAULT_DONE_KEYS`](data_replaybuffers.html#torchrl.data.DEFAULT_DONE_KEYS) rather than `done` alone.
...
[`BaseCollector`](generated/torchrl.collectors.BaseCollector.html#torchrl.collectors.BaseCollector) subclass by default
(`track_traj_ids=False` disables it). When present,
[`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler) uses this directly instead of
...
trajectory because of any of the [`DEFAULT_DONE_KEYS`](data_replaybuffers.html#torchrl.data.DEFAULT_DONE_KEYS)
...
episodes. [`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler) reads a
...
implemented by [`find_start_stop_traj()`](generated/torchrl.data.find_start_stop_traj.html#torchrl.data.find_start_stop_traj), which
[`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler) uses under the hood --
...
[`DEFAULT_DONE_KEYS`](data_replaybuffers.html#torchrl.data.DEFAULT_DONE_KEYS) flags set.

New components that need trajectory boundaries should call
[`find_start_stop_traj()`](generated/torchrl.data.find_start_stop_traj.html#torchrl.data.find_start_stop_traj) rather than reimplement these
...
[`LazyTensorStorage`](generated/torchrl.data.replay_buffers.LazyTensorStorage.html#torchrl.data.replay_buffers.LazyTensorStorage) (and friends)
...
[`ParallelEnv`](generated/torchrl.envs.ParallelEnv.html#torchrl.envs.ParallelEnv) rollouts), because that lets the
...
order), and a [`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler) drawing whole rows would
silently span them.
...
[`ReplayBufferEnsemble`](generated/torchrl.data.ReplayBufferEnsemble.html#torchrl.data.ReplayBufferEnsemble). Each member
...
data-layout-buffer-to-collector below.
...
[`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler)'s boundary detection works on a flat
...
[`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler) consumes a flat 1-D
...
[`InitTracker`](generated/torchrl.envs.transforms.InitTracker.html#torchrl.envs.transforms.InitTracker)).
...
[`set_recurrent_mode`](generated/torchrl.modules.set_recurrent_mode.html#torchrl.modules.set_recurrent_mode) `("recurrent")`: the
...
[`EnvBase`](generated/torchrl.envs.EnvBase.html#torchrl.envs.EnvBase) metaclass post-init hook walks the
policy looking for recurrent submodules (anything implementing
`make_tensordict_primer()`) and appends an
[`InitTracker`](generated/torchrl.envs.transforms.InitTracker.html#torchrl.envs.transforms.InitTracker) plus the matching
[`TensorDictPrimer`](generated/torchrl.envs.transforms.TensorDictPrimer.html#torchrl.envs.transforms.TensorDictPrimer) to the env when
...
[`Collector`](generated/torchrl.collectors.Collector.html#torchrl.collectors.Collector) (or any subclass) is constructed
...
[`SerialEnv`](generated/torchrl.envs.SerialEnv.html#torchrl.envs.SerialEnv) / [`ParallelEnv`](generated/torchrl.envs.ParallelEnv.html#torchrl.envs.ParallelEnv)
where transforms live in child envs. Limitations and the v0.15 default
flip are documented in the
[policy= argument page](envs_api.html#environment-policy-arg).
...
[`split_trajectories()`](generated/torchrl.collectors.utils.split_trajectories.html#torchrl.collectors.utils.split_trajectories) and the
...
(data-layout-padded-discouraged), this introduces a more subtle
...
buffer with a [`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler).
...
[`canonicalize()`](generated/torchrl.modules.LSTMModule.html#torchrl.modules.LSTMModule.canonicalize) (and its
[`GRUModule`](generated/torchrl.modules.GRUModule.html#torchrl.modules.GRUModule) twin) canonicalize only the subset of
keys the module actually reads/writes (`canonical_keys`), leaving
...
Pair with [`cuda_memory_profile`](generated/torchrl.cuda_memory_profile.html#torchrl.cuda_memory_profile) to verify the win:
...
[`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler) and feeds them straight
into a recurrent policy, the contiguous-batch pattern described on this
page.
- [Collectors and Replay Buffers](collectors_replay.html) -- concrete `ndim` patterns and the full
`trajs_per_batch` API.
- [Auto-wrapping recurrent transforms](envs_api.html#environment-policy-arg) --
the `policy=` env argument and the collector-side equivalent.
- [`SliceSampler`](generated/torchrl.data.replay_buffers.SliceSampler.html#torchrl.data.replay_buffers.SliceSampler) -- reference for the
sampler used throughout this page.
- [`LSTMModule`](generated/torchrl.modules.LSTMModule.html#torchrl.modules.LSTMModule),
[`GRUModule`](generated/torchrl.modules.GRUModule.html#torchrl.modules.GRUModule),
[`set_recurrent_mode`](generated/torchrl.modules.set_recurrent_mode.html#torchrl.modules.set_recurrent_mode) -- the recurrent modules
that consume the contiguous-trajectory layout natively.
- [`canonicalize_rnn_subset()`](generated/torchrl.modules.canonicalize_rnn_subset.html#torchrl.modules.canonicalize_rnn_subset) -- narrow
canonicalization for multi-RNN learners.
- [Recurrent modules](modules_rnn.html) -- recurrent execution modes, backend selection, and
