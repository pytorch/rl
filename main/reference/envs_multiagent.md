...
each group is its own nested tensordict. See Multiple agent groups for the
general contract a native [`EnvBase`](generated/torchrl.envs.EnvBase.html#torchrl.envs.EnvBase) `_step()` must implement.
...
[`EnvBase`](generated/torchrl.envs.EnvBase.html#torchrl.envs.EnvBase) can expose any number of groups - `"red"` /
...
[`MarlGroupMapType`](generated/torchrl.envs.MarlGroupMapType.html#torchrl.envs.MarlGroupMapType) and
[`check_marl_grouping()`](generated/torchrl.envs.check_marl_grouping.html#torchrl.envs.check_marl_grouping).

The canonical trained example of this layout is the
[competitive MADDPG tutorial](../tutorials/multiagent_competitive_ddpg.html)
(in particular the *Rollout* section), which consumes the `"agents"` /
`"adversaries"` groups of *simple_tag*.

### What `_step()` must return

[`step()`](generated/torchrl.envs.EnvBase.html#id4) is a thin wrapper: it calls the private
...
[`step()`](generated/torchrl.envs.EnvBase.html#id4) does that;
...
Multi-group key tree returned by a native `_step()`
...
[`EnvBase`](generated/torchrl.envs.EnvBase.html#torchrl.envs.EnvBase) also accepts environments whose done /
...
[`Composite`](generated/torchrl.data.Composite.html#torchrl.data.Composite) carries shape `(*batch, n_agents_in_group)`;
root-level (shared) specs carry shape `(*batch,)` or `(*batch, 1)`.

Specs for a two-group env (shared done, per-group obs/reward/action)
...
Call [`check_env_specs()`](generated/torchrl.envs.check_env_specs.html#torchrl.envs.check_env_specs) after construction: it runs a
...
[`EnvBase`](generated/torchrl.envs.EnvBase.html#torchrl.envs.EnvBase). It is not a PettingZoo or VMAS wrapper:
...
Native multi-group `EnvBase._step()`
...
with the individual `NestedKey` values accepted by its
