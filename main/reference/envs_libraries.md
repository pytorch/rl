...
| [`CraftGroundEnv`](generated/torchrl.envs.CraftGroundEnv.html#torchrl.envs.CraftGroundEnv)(*args, **kwargs) | CraftGround (Minecraft) environment built from a configuration. |
| [`CraftGroundWrapper`](generated/torchrl.envs.CraftGroundWrapper.html#torchrl.envs.CraftGroundWrapper)(*args, **kwargs) | CraftGround (Minecraft) environment wrapper. |
...
**Minecraft licensing** ([`CraftGroundEnv`](generated/torchrl.envs.CraftGroundEnv.html#torchrl.envs.CraftGroundEnv),
[`CraftGroundWrapper`](generated/torchrl.envs.CraftGroundWrapper.html#torchrl.envs.CraftGroundWrapper)): TorchRL does not ship or
...
[knowledge_base/MINECRAFT.md](https://github.com/pytorch/rl/blob/main/knowledge_base/MINECRAFT.md)
