...
| [`DoneTransform`](generated/torchrl.envs.transforms.DoneTransform.html#torchrl.envs.transforms.DoneTransform)([in_keys, out_keys, ...]) | Expands done flags to match the reward shape. |
...
| [`ClosedLoopMultiAction`](generated/torchrl.envs.transforms.ClosedLoopMultiAction.html#torchrl.envs.transforms.ClosedLoopMultiAction)(controller, *, steps) | Execute a controller against fresh observations for one high-level decision. |
