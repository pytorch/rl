...
| [`MJLabEnvConfig`](generated/torchrl.trainers.algorithms.configs.envs_libs.MJLabEnvConfig.html#torchrl.trainers.algorithms.configs.envs_libs.MJLabEnvConfig)([_partial_, task_id, cfg, ...]) | Configuration for MJLabEnv environment. |
...
| [`TdMpc2MLPConfig`](generated/torchrl.trainers.algorithms.configs.modules.TdMpc2MLPConfig.html#torchrl.trainers.algorithms.configs.modules.TdMpc2MLPConfig)([_partial_, in_features, ...]) | A class to configure a TDMPC2 multilayer perceptron. |
| [`TdMpc2WorldModelConfig`](generated/torchrl.trainers.algorithms.configs.modules.TdMpc2WorldModelConfig.html#torchrl.trainers.algorithms.configs.modules.TdMpc2WorldModelConfig)([observation_dim, ...]) | Configuration for a TD-MPC2 world model. |
...
| [`DreamerV3DiscreteActorConfig`](generated/torchrl.trainers.algorithms.configs.modules.DreamerV3DiscreteActorConfig.html#torchrl.trainers.algorithms.configs.modules.DreamerV3DiscreteActorConfig)([_partial_, ...]) | Hydra configuration for `DreamerV3DiscreteActor`. |
| [`DreamerV3SeededPolicyConfig`](generated/torchrl.trainers.algorithms.configs.modules.DreamerV3SeededPolicyConfig.html#torchrl.trainers.algorithms.configs.modules.DreamerV3SeededPolicyConfig)([_partial_, ...]) | Hydra configuration for `DreamerV3SeededPolicy`. |
| [`DreamerV3ImageEncoderConfig`](generated/torchrl.trainers.algorithms.configs.modules.DreamerV3ImageEncoderConfig.html#torchrl.trainers.algorithms.configs.modules.DreamerV3ImageEncoderConfig)(_partial_, ...) | Hydra configuration for [`DreamerV3ImageEncoder`](generated/torchrl.modules.DreamerV3ImageEncoder.html#torchrl.modules.DreamerV3ImageEncoder). |
| [`DreamerV3ImageDecoderConfig`](generated/torchrl.trainers.algorithms.configs.modules.DreamerV3ImageDecoderConfig.html#torchrl.trainers.algorithms.configs.modules.DreamerV3ImageDecoderConfig)(_partial_, ...) | Hydra configuration for [`DreamerV3ImageDecoder`](generated/torchrl.modules.DreamerV3ImageDecoder.html#torchrl.modules.DreamerV3ImageDecoder). |
...
| [`CatTensorsConfig`](generated/torchrl.trainers.algorithms.configs.transforms.CatTensorsConfig.html#torchrl.trainers.algorithms.configs.transforms.CatTensorsConfig)([dim, in_keys, out_key, ...]) | Configuration for CatTensors transform. |
...
| [`DoneTransformConfig`](generated/torchrl.trainers.algorithms.configs.transforms.DoneTransformConfig.html#torchrl.trainers.algorithms.configs.transforms.DoneTransformConfig)([in_keys, out_keys, ...]) | Hydra configuration for [`DoneTransform`](generated/torchrl.envs.transforms.DoneTransform.html#torchrl.envs.transforms.DoneTransform). |
...
| [`LastActionConfig`](generated/torchrl.trainers.algorithms.configs.transforms.LastActionConfig.html#torchrl.trainers.algorithms.configs.transforms.LastActionConfig)([in_keys, out_keys, ...]) | Hydra configuration for [`LastAction`](generated/torchrl.envs.transforms.LastAction.html#torchrl.envs.transforms.LastAction). |
...
| [`MultiActionConfig`](generated/torchrl.trainers.algorithms.configs.transforms.MultiActionConfig.html#torchrl.trainers.algorithms.configs.transforms.MultiActionConfig)([dim, stack_rewards, ...]) | Hydra configuration for [`MultiAction`](generated/torchrl.envs.transforms.MultiAction.html#torchrl.envs.transforms.MultiAction). |
| [`ClosedLoopMultiActionConfig`](generated/torchrl.trainers.algorithms.configs.transforms.ClosedLoopMultiActionConfig.html#torchrl.trainers.algorithms.configs.transforms.ClosedLoopMultiActionConfig)([controller, ...]) | Hydra configuration for [`ClosedLoopMultiAction`](generated/torchrl.envs.transforms.ClosedLoopMultiAction.html#torchrl.envs.transforms.ClosedLoopMultiAction). |
...
| [`KLRewardTransformConfig`](generated/torchrl.trainers.algorithms.configs.transforms.KLRewardTransformConfig.html#torchrl.trainers.algorithms.configs.transforms.KLRewardTransformConfig)([ref_model, ...]) | Hydra configuration for [`KLRewardTransform`](generated/torchrl.envs.llm.transforms.KLRewardTransform.html#torchrl.envs.llm.transforms.KLRewardTransform). |
...
| [`SliceSamplerConfig`](generated/torchrl.trainers.algorithms.configs.data.SliceSamplerConfig.html#torchrl.trainers.algorithms.configs.data.SliceSamplerConfig)([_target_, num_slices, ...]) | Hydra configuration for `SliceSampler`. |
| [`SliceSamplerWithoutReplacementConfig`](generated/torchrl.trainers.algorithms.configs.data.SliceSamplerWithoutReplacementConfig.html#torchrl.trainers.algorithms.configs.data.SliceSamplerWithoutReplacementConfig)([...]) | Hydra configuration for `SliceSamplerWithoutReplacement`. |
| [`StreamingSliceSamplerConfig`](generated/torchrl.trainers.algorithms.configs.data.StreamingSliceSamplerConfig.html#torchrl.trainers.algorithms.configs.data.StreamingSliceSamplerConfig)([_target_, ...]) | Hydra configuration for `StreamingSliceSampler`. |
...
| [`StorageEnsembleWriterConfig`](generated/torchrl.trainers.algorithms.configs.data.StorageEnsembleWriterConfig.html#torchrl.trainers.algorithms.configs.data.StorageEnsembleWriterConfig)(_partial_, ...) | Hydra configuration for [`WriterEnsemble`](generated/torchrl.data.replay_buffers.WriterEnsemble.html#torchrl.data.replay_buffers.WriterEnsemble). |
...
| [`FQLTrainerConfig`](generated/torchrl.trainers.algorithms.configs.trainers.FQLTrainerConfig.html#torchrl.trainers.algorithms.configs.trainers.FQLTrainerConfig)(loss_module, optimizer, ...) | Hydra configuration for [`FQLTrainer`](generated/torchrl.trainers.algorithms.FQLTrainer.html#torchrl.trainers.algorithms.FQLTrainer). |
...
| [`FQLLossConfig`](generated/torchrl.trainers.algorithms.configs.objectives.FQLLossConfig.html#torchrl.trainers.algorithms.configs.objectives.FQLLossConfig)([_partial_, flow_policy, ...]) | Hydra configuration for [`FQLLoss`](generated/torchrl.objectives.FQLLoss.html#torchrl.objectives.FQLLoss). |
...
| [`LionConfig`](generated/torchrl.trainers.algorithms.configs.utils.LionConfig.html#torchrl.trainers.algorithms.configs.utils.LionConfig)([lr, betas, weight_decay, ...]) | Configuration for a Lion optimizer node. |
