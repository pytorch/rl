...
- [Selecting the sequence backend](dreamer_v3.html#selecting-the-sequence-backend)
- [The three objectives](dreamer_v3.html#the-three-objectives)
- [Reconstruction heads](dreamer_v3.html#reconstruction-heads)
- [Optimization and training loop](dreamer_v3.html#optimization-and-training-loop)
- [API map](dreamer_v3.html#api-map)
- [Checkpoint ownership](dreamer_v3.html#checkpoint-ownership)