...
*class*torchrl.envs.HopperEnv(**args*, *num_workers: int = 1*, *parallel: bool | None = None*, ***kwargs*)[[source]](../../_modules/torchrl/envs/custom/mujoco/hopper.html#HopperEnv)
...
```
>>> from torchrl.envs import HopperEnv 
>>> env = HopperEnv(num_envs=4) 
>>> td = env.rollout(10)
```
