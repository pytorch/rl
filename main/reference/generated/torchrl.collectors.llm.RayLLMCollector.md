...
*property*init_random_frames*: int*

Number of random warmup frames (always 0 for LLM collectors).

The remote [`LLMCollector`](torchrl.collectors.llm.LLMCollector.html#torchrl.collectors.llm.LLMCollector) is created
without `init_random_frames`, so the local wrapper reports 0. This
attribute is read by [`Trainer`](torchrl.trainers.Trainer.html#torchrl.trainers.Trainer).
