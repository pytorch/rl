...
*class*torchrl.collectors.llm.RayLLMCollector(*env: [EnvBase](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase) | Callable[[], [EnvBase](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase)]*, ***, *policy: Callable[[[TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)], [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)] | None = None*, *policy_factory: Callable[[], Callable[[[TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)], [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)]] | None = None*, *dialog_turns_per_batch: int*, *total_dialog_turns: int = -1*, *yield_only_last_steps: bool | None = None*, *yield_completed_trajectories: bool | None = None*, *postproc: Callable[[[TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)], [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)] | None = None*, *async_envs: bool | None = None*, *replay_buffer: [ReplayBuffer](torchrl.data.ReplayBuffer.html#torchrl.data.ReplayBuffer) | None = None*, *reset_at_each_iter: bool = False*, *flatten_data: bool | None = None*, *weight_updater: [WeightUpdaterBase](torchrl.collectors.WeightUpdaterBase.html#torchrl.collectors.WeightUpdaterBase) | Callable[[], [WeightUpdaterBase](torchrl.collectors.WeightUpdaterBase.html#torchrl.collectors.WeightUpdaterBase)] | None = None*, *ray_init_config: dict[str, Any] | None = None*, *remote_config: dict[str, Any] | None = None*, *track_policy_version: bool | [PolicyVersion](torchrl.envs.llm.transforms.PolicyVersion.html#torchrl.envs.llm.transforms.PolicyVersion) = False*, *sync_iter: bool = True*, *verbose: bool = False*, *num_cpus: int | None = None*, *num_gpus: int | None = None*)[[source]](../../_modules/torchrl/collectors/llm/ray_collector.html#RayLLMCollector)
...
before returning it.
- **weight_updater** ([*WeightUpdaterBase*](torchrl.collectors.WeightUpdaterBase.html#torchrl.collectors.WeightUpdaterBase)*or**constructor**,**optional*) - An instance of WeightUpdaterBase
...
if True, items yielded by the collector will be synced to the local process.
If False, the collector will collect the next batch of data in between yielding.
This has no effect when data is collected through the `start()` method.
For example:
...
This is somewhat equivalent to using [`MultiSyncCollector`](torchrl.collectors.MultiSyncCollector.html#torchrl.collectors.MultiSyncCollector) (sync_iter=True) or
[`MultiAsyncCollector`](torchrl.collectors.MultiAsyncCollector.html#torchrl.collectors.MultiAsyncCollector) (sync_iter=False).
Defaults to True.
...
async_shutdown(*timeout=None*)[[source]](../../_modules/torchrl/collectors/llm/ray_collector.html#RayLLMCollector.async_shutdown)
...
increment_version()[[source]](../../_modules/torchrl/collectors/llm/ray_collector.html#RayLLMCollector.increment_version)

Increment the policy version.

init_updater(**args*, ***kwargs*)[[source]](../../_modules/torchrl/collectors/llm/ray_collector.html#RayLLMCollector.init_updater)
...
next() → None[[source]](../../_modules/torchrl/collectors/llm/ray_collector.html#RayLLMCollector.next)
...
shutdown()[[source]](../../_modules/torchrl/collectors/llm/ray_collector.html#RayLLMCollector.shutdown)

Shuts down the collector.

start()[[source]](../../_modules/torchrl/collectors/llm/ray_collector.html#RayLLMCollector.start)
...
*property*weight_updater*: [WeightUpdaterBase](torchrl.collectors.WeightUpdaterBase.html#torchrl.collectors.WeightUpdaterBase)*
