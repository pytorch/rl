...
*class*torchrl.envs.ChessEnv(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/custom/chess.html#ChessEnv)
...
Requires: the chess library. More info [here](https://python-chess.readthedocs.io/en/latest/).
...
- **mask_actions** (*bool*) - if `True`, a `ActionMask` transform will be appended
...
The action spec is a [`Categorical`](torchrl.data.Categorical.html#torchrl.data.Categorical) with a number of actions equal to the number of possible SAN moves.
...
cardinality(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase) | None = None*) → int[[source]](../../_modules/torchrl/envs/custom/chess.html#ChessEnv.cardinality)
...
get_legal_moves(*tensordict=None*, *uci=False*)[[source]](../../_modules/torchrl/envs/custom/chess.html#ChessEnv.get_legal_moves)
