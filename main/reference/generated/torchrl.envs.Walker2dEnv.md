...
*class*torchrl.envs.Walker2dEnv(**args*, *num_workers: int = 1*, *parallel: bool | None = None*, ***kwargs*)[[source]](../../_modules/torchrl/envs/custom/mujoco/walker.html#Walker2dEnv)
...
```
>>> from torchrl.envs import Walker2dEnv 
>>> env = Walker2dEnv(num_envs=4) 
>>> td = env.rollout(10)
```
