...
*class*torchrl.weight_update.llm.VLLMWeightSyncScheme(*master_address: str | None = None*, *master_port: int | None = None*, *gpus_per_replica: int = 1*, *num_replicas: int = 1*, *strategy: Literal['tensordict', 'state_dict'] = 'tensordict'*, *device: [device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | str | int = 0*)[[source]](../../_modules/torchrl/weight_update/llm/vllm_nccl.html#VLLMWeightSyncScheme)
...
create_receiver(*vllm_engine*) → [VLLMWeightReceiver](torchrl.weight_update.llm.VLLMWeightReceiver.html#torchrl.weight_update.llm.VLLMWeightReceiver)[[source]](../../_modules/torchrl/weight_update/llm/vllm_nccl.html#VLLMWeightSyncScheme.create_receiver)
...
create_sender() → [VLLMWeightSender](torchrl.weight_update.llm.VLLMWeightSender.html#torchrl.weight_update.llm.VLLMWeightSender)[[source]](../../_modules/torchrl/weight_update/llm/vllm_nccl.html#VLLMWeightSyncScheme.create_sender)

Create a weight sender for the trainer process.

create_transport(***kwargs*) → [VLLMCollectiveTransport](torchrl.weight_update.llm.VLLMCollectiveTransport.html#torchrl.weight_update.llm.VLLMCollectiveTransport)[[source]](../../_modules/torchrl/weight_update/llm/vllm_nccl.html#VLLMWeightSyncScheme.create_transport)
