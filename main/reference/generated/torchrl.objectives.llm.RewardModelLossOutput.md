...
*class*torchrl.objectives.llm.RewardModelLossOutput(*loss_reward_model: 'torch.Tensor'*, *loss_center: 'torch.Tensor | None' = None*, *accuracy: 'torch.Tensor | None' = None*, ***, *batch_size*, *device=None*, *names=None*)[[source]](../../_modules/torchrl/objectives/llm/reward.html#RewardModelLossOutput)
