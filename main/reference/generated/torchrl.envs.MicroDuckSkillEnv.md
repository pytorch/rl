...
*class*torchrl.envs.MicroDuckSkillEnv(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/custom/mujoco/microduck_controller.html#MicroDuckSkillEnv)

High-level environment whose actions select frozen MicroDuck skills.

A `MicroDuckSkills` object is part of this environment's transition
...
Construct this class with `from_env()`; the wrapped task environment
...
... )
>>> rollout = env.rollout(10, high_level_policy)
```

See also

[`MicroDuckSkillController`](torchrl.envs.MicroDuckSkillController.html#torchrl.envs.MicroDuckSkillController) maps one skill decision to policy
inputs and joint targets;
[`MicroDuckSkills`](torchrl.modules.tensordict_module.zoo.MicroDuckSkills.html#torchrl.modules.tensordict_module.zoo.MicroDuckSkills)
keeps the policy and task metadata together; and
[`ClosedLoopMultiAction`](torchrl.envs.transforms.ClosedLoopMultiAction.html#torchrl.envs.transforms.ClosedLoopMultiAction) implements the
...
*classmethod*from_env(*env: [EnvBase](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase)*, *skills: [MicroDuckSkills](torchrl.modules.tensordict_module.zoo.MicroDuckSkills.html#torchrl.modules.tensordict_module.zoo.MicroDuckSkills)*, ***, *skill_ids: [Sequence](torchrl.data.Sequence.html#torchrl.data.Sequence)[int] | None = None*, *control_steps_per_decision: int = 5*, *control_period_s: float = 0.02*, *group_key: NestedKey | None = 'agents'*, *argument_key: NestedKey | None = None*, *reset_key: NestedKey | None = 'fallen'*) → MicroDuckSkillEnv[[source]](../../_modules/torchrl/envs/custom/mujoco/microduck_controller.html#MicroDuckSkillEnv.from_env)
...
A high-level `MicroDuckSkillEnv`.
