...
*class*torchrl.modules.llm.Tokens(*prompt: 'torch.Tensor | None' = None*, *response: 'torch.Tensor | None' = None*, *full: 'torch.Tensor | None' = None*, *padded: 'bool | None' = None*, ***, *batch_size*, *device=None*, *names=None*)[[source]](../../_modules/torchrl/modules/llm/policies/common.html#Tokens)
...
*classmethod*default_spec(*shape=(-1,)*, *keys: list[Literal['prompt', 'response', 'full']] | None = None*)[[source]](../../_modules/torchrl/modules/llm/policies/common.html#Tokens.default_spec)
...
to_history(*tokenizer: AutoTokenizer*, *chat_template_name: str | None = None*, *skip_special_tokens: bool = False*) → [ChatHistory](torchrl.modules.llm.ChatHistory.html#torchrl.modules.llm.ChatHistory)[[source]](../../_modules/torchrl/modules/llm/policies/common.html#Tokens.to_history)
...
to_text(*tokenizer: AutoTokenizer*, *skip_special_tokens: bool = False*) → [Text](torchrl.modules.llm.Text.html#torchrl.modules.llm.Text)[[source]](../../_modules/torchrl/modules/llm/policies/common.html#Tokens.to_text)
