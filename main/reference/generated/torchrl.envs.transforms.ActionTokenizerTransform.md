...
*class*torchrl.envs.transforms.ActionTokenizerTransform(*tokenizer: [ActionTokenizerBase](torchrl.data.vla.ActionTokenizerBase.html#torchrl.data.vla.ActionTokenizerBase)*, ***, *in_key: NestedKey = 'action'*, *out_key: NestedKey = 'action_tokens'*)[[source]](../../_modules/torchrl/envs/transforms/_action.html#ActionTokenizerTransform)
