...
*class*torchrl.data.vla.VLAAction(*chunk: 'torch.Tensor | None' = None*, *tokens: 'torch.Tensor | None' = None*, *raw_tokens: 'torch.Tensor | None' = None*, *logits: 'torch.Tensor | None' = None*, *log_probs: 'torch.Tensor | None' = None*, *mask: 'torch.Tensor | None' = None*, *padded: 'bool | None' = None*, ***, *batch_size*, *device=None*, *names=None*)[[source]](../../_modules/torchrl/data/vla/containers.html#VLAAction)
