...
*class*torchrl.envs.ProcessorAsyncEnvPool(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/async_envs.html#ProcessorAsyncEnvPool)
...
async_step_recv(*min_get*)[[source]](../../_modules/torchrl/envs/async_envs.html#ProcessorAsyncEnvPool.async_step_recv)

Receives the results of the step command.

async_reset_send(*tensordict*)[[source]](../../_modules/torchrl/envs/async_envs.html#ProcessorAsyncEnvPool.async_reset_send)

Sends a reset command to the environments.

async_reset_recv(*min_get*)[[source]](../../_modules/torchrl/envs/async_envs.html#ProcessorAsyncEnvPool.async_reset_recv)

Receives the results of the reset command.

shutdown()[[source]](../../_modules/torchrl/envs/async_envs.html#ProcessorAsyncEnvPool.shutdown)

Shuts down all environment processes.
...
async_step_and_maybe_reset_recv(*min_get: int = 1*, *env_index: int | None = None*, ***, *max_get: int | None = None*, *timeout: float | None = None*) → tuple[[TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase), [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)][[source]](../../_modules/torchrl/envs/async_envs.html#ProcessorAsyncEnvPool.async_step_and_maybe_reset_recv)
...
async_step_recv(*min_get: int = 1*, *env_index: int | None = None*, ***, *max_get: int | None = None*, *timeout: float | None = None*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/envs/async_envs.html#ProcessorAsyncEnvPool.async_step_recv)
