...
([arXiv:2509.09674](https://arxiv.org/abs/2509.09674)). It expects dense, same-shaped
...
This transform assumes that [`add()`](torchrl.data.ReplayBuffer.html#torchrl.data.ReplayBuffer.add) and [`extend()`](torchrl.data.ReplayBuffer.html#torchrl.data.ReplayBuffer.extend)
...
writer processes, `share_memory_()` is called automatically by
`share()`. This centralizes the incomplete
...
- **candidate_selector** ([*MCAdvantageSelector*](torchrl.objectives.llm.MCAdvantageSelector.html#torchrl.objectives.llm.MCAdvantageSelector)*,**optional*) - Strategy used to select `grpo_size`
...
forward(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → [GRPOLossOutput](torchrl.objectives.llm.GRPOLossOutput.html#torchrl.objectives.llm.GRPOLossOutput)[[source]](../../_modules/torchrl/objectives/llm/grpo.html#MCAdvantage.forward)
...
reset_stats() → None[[source]](../../_modules/torchrl/objectives/llm/grpo.html#MCAdvantage.reset_stats)
...
share_memory_() → MCAdvantage[[source]](../../_modules/torchrl/objectives/llm/grpo.html#MCAdvantage.share_memory_)
