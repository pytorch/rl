...
*class*torchrl.envs.llm.transforms.ExecuteToolsInOrder(*registry: [ToolRegistry](torchrl.envs.llm.transforms.ToolRegistry.html#torchrl.envs.llm.transforms.ToolRegistry)*, *parser: LLMToolParser*, *stop_on_error: bool = False*, *pass_state_to_tools: bool = True*)[[source]](../../_modules/torchrl/envs/llm/transforms/tools.html#ExecuteToolsInOrder)
...
- **registry** ([*ToolRegistry*](torchrl.envs.llm.transforms.ToolRegistry.html#torchrl.envs.llm.transforms.ToolRegistry)) - Registry containing available tool services.
