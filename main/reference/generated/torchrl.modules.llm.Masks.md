...
*class*torchrl.modules.llm.Masks(*all_attention_mask: 'torch.Tensor | None' = None*, *all_assistant_mask: 'torch.Tensor | None' = None*, *padded: 'bool | None' = None*, ***, *batch_size*, *device=None*, *names=None*)[[source]](../../_modules/torchrl/modules/llm/policies/common.html#Masks)
...
*classmethod*default_spec(*shape=(-1,)*, *keys: list[Literal['all_attention_mask', 'all_assistant_mask']] | None = None*)[[source]](../../_modules/torchrl/modules/llm/policies/common.html#Masks.default_spec)
