...
*class*torchrl.trainers.algorithms.FQLTrainer(**args*, ***kwargs*)[[source]](../../_modules/torchrl/trainers/algorithms/fql.html#FQLTrainer)

Train FQL with shared offline-to-online replay and Trainer lifecycle hooks.

See `FQLTrainerConfig` for the
...
without changing its checkpoint keys. See [`OfflineToOnlineTrainer`](torchrl.trainers.algorithms.OfflineToOnlineTrainer.html#torchrl.trainers.algorithms.OfflineToOnlineTrainer)
for logging, checkpointing and hook options.

Parameters:

- **loss_module** ([*FQLLoss*](torchrl.objectives.FQLLoss.html#torchrl.objectives.FQLLoss)) - flow, actor and critic objective.
- **optimizer** ([*torch.optim.Optimizer*](https://docs.pytorch.org/docs/stable/optim.html#torch.optim.Optimizer)) - optimizer for the loss parameters.
- **replay_buffer** ([*ReplayBuffer*](torchrl.data.ReplayBuffer.html#torchrl.data.ReplayBuffer)) - offline dataset and online replay storage.
- **target_net_updater** (*TargetNetUpdater*) - critic target update rule.
- **offline_steps** (*int*) - gradient updates before online collection.

Keyword Arguments:

- **logger** ([*Logger*](torchrl.record.loggers.Logger.html#torchrl.record.loggers.Logger)*,**optional*) - scalar logger. Defaults to `None`.
- **checkpoint** ([*Checkpoint*](torchrl.checkpoint.Checkpoint.html#torchrl.checkpoint.Checkpoint)*,**optional*) - checkpoint component registry.
- **checkpoint_rotation** ([*CheckpointRotation*](torchrl.checkpoint.CheckpointRotation.html#torchrl.checkpoint.CheckpointRotation)*,**optional*) - checkpoint retention
...
update() → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)
