...
*class*torchrl.objectives.llm.RayMCAdvantage(*grpo_size: int*, *prompt_key: NestedKey = 'query'*, *rewards_key: NestedKey = ('next', 'reward')*, *advantage_key: NestedKey = 'advantage'*, *done_key: NestedKey = ('next', 'done')*, *verbose: bool = False*, ***, *trajectory_return: Literal['sum', 'max', 'mean'] | None = None*, *keep_return_bounds: tuple[float, float] | None = None*, *candidate_group_size: int | None = None*, *candidate_selection_min_size: int | None = None*, *candidate_selector: [MCAdvantageSelector](torchrl.objectives.llm.MCAdvantageSelector.html#torchrl.objectives.llm.MCAdvantageSelector) | None = None*, *ray_init_config: dict | None = None*, *remote_config: dict | None = None*, *actor_name: str | None = None*)[[source]](../../_modules/torchrl/objectives/llm/grpo.html#RayMCAdvantage)

Ray actor-backed [`MCAdvantage`](torchrl.objectives.llm.MCAdvantage.html#torchrl.objectives.llm.MCAdvantage).

`RayMCAdvantage` mirrors [`MCAdvantage`](torchrl.objectives.llm.MCAdvantage.html#torchrl.objectives.llm.MCAdvantage) but stores grouping queues
...
buffer is already a [`RayReplayBuffer`](torchrl.data.RayReplayBuffer.html#torchrl.data.RayReplayBuffer), prefer passing
...
- **trajectory_return** (*str**,**optional*) - See [`MCAdvantage`](torchrl.objectives.llm.MCAdvantage.html#torchrl.objectives.llm.MCAdvantage).
- **keep_return_bounds** (*tuple**of**float**,**optional*) - See [`MCAdvantage`](torchrl.objectives.llm.MCAdvantage.html#torchrl.objectives.llm.MCAdvantage).
- **candidate_group_size** (*int**,**optional*) - See [`MCAdvantage`](torchrl.objectives.llm.MCAdvantage.html#torchrl.objectives.llm.MCAdvantage).
- **candidate_selection_min_size** (*int**,**optional*) - See [`MCAdvantage`](torchrl.objectives.llm.MCAdvantage.html#torchrl.objectives.llm.MCAdvantage).
- **candidate_selector** ([*MCAdvantageSelector*](torchrl.objectives.llm.MCAdvantageSelector.html#torchrl.objectives.llm.MCAdvantageSelector)*,**optional*) - See
[`MCAdvantage`](torchrl.objectives.llm.MCAdvantage.html#torchrl.objectives.llm.MCAdvantage).
- **ray_init_config** (*dict**,**optional*) - Keyword arguments for
`ray.init()` when Ray is not initialized yet.
- **remote_config** (*dict**,**optional*) - Keyword arguments for
`ray.remote()` when creating the actor. Defaults to
`{"num_cpus": 1}`.
...
close() → None[[source]](../../_modules/torchrl/objectives/llm/grpo.html#RayMCAdvantage.close)
...
*property*max_queued_trajectories_per_group*: int*
...
reset_stats() → None[[source]](../../_modules/torchrl/objectives/llm/grpo.html#RayMCAdvantage.reset_stats)
...
share_memory_() → RayMCAdvantage[[source]](../../_modules/torchrl/objectives/llm/grpo.html#RayMCAdvantage.share_memory_)
