...
- **ChatHistory Integration**: Limited support for the new `ChatHistory` objects.
- **Input Mode Support**: May not handle all input modes ("history", "text", "tokens") consistently.

**Recommendation**:
Use [`RetrieveKL`](torchrl.envs.llm.transforms.RetrieveKL.html#torchrl.envs.llm.transforms.RetrieveKL) for new code, which provides:
...
**ref_model** ([*LLMWrapperBase*](torchrl.modules.llm.LLMWrapperBase.html#torchrl.modules.llm.LLMWrapperBase)) - the reference model.
...
[`RetrieveKL`](torchrl.envs.llm.transforms.RetrieveKL.html#torchrl.envs.llm.transforms.RetrieveKL): The recommended transform for KL divergence computation.
[`RetrieveLogProb`](torchrl.envs.llm.transforms.RetrieveLogProb.html#torchrl.envs.llm.transforms.RetrieveLogProb): Base transform for retrieving log-probabilities.
[`KLComputation`](torchrl.envs.llm.transforms.KLComputation.html#torchrl.envs.llm.transforms.KLComputation): Transform for computing KL divergence between log-prob tensors.
...
transform_output_spec(*output_spec: [Composite](torchrl.data.Composite.html#torchrl.data.Composite)*) → [Composite](torchrl.data.Composite.html#torchrl.data.Composite)[[source]](../../_modules/torchrl/envs/llm/transforms/kl.html#KLRewardTransform.transform_output_spec)
