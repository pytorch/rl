...
*class*torchrl.objectives.FQLLoss(**args*, ***kwargs*)[[source]](../../_modules/torchrl/objectives/fql.html#FQLLoss)

Flow Q-learning for normalized continuous actions.

Implements [https://arxiv.org/abs/2502.02538](https://arxiv.org/abs/2502.02538). The flow learns the behavior
distribution; the one-step actor balances distillation and mean critic value.
Only the critics have target parameters, updated with `SoftUpdate`.

Parameters:

- **flow_policy** ([*FlowMatchingPolicy*](torchrl.modules.FlowMatchingPolicy.html#torchrl.modules.FlowMatchingPolicy)*or**TensorDictSequential*) - behavior flow
policy, optionally preceded by TensorDict observation encoders.
- **actor_network** ([*OneStepPolicy*](torchrl.modules.OneStepPolicy.html#torchrl.modules.OneStepPolicy)*or**TensorDictSequential*) - noise-conditioned
...
- **alpha** ([*float*](torchrl.data.llm.TopKRewardSelector.html#torchrl.data.llm.TopKRewardSelector.float)*,**optional*) - distillation weight. Defaults to 10.
...
make_value_estimator(*value_type=None*, ***hyperparams*)[[source]](../../_modules/torchrl/objectives/fql.html#FQLLoss.make_value_estimator)
