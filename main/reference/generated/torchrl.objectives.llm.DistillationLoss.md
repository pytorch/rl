...
*class*torchrl.objectives.llm.DistillationLoss(**args*, ***kwargs*)[[source]](../../_modules/torchrl/objectives/llm/distillation.html#DistillationLoss)

Token-level knowledge-distillation loss for LLM policies.
...
[`RetrieveLogProb`](torchrl.envs.llm.transforms.RetrieveLogProb.html#torchrl.envs.llm.transforms.RetrieveLogProb) transform wrapping
...
([`k3_kl_token_estimate()`](torchrl.objectives.llm.k3_kl_token_estimate.html#torchrl.objectives.llm.k3_kl_token_estimate)), the same
...
[`SFTLoss`](torchrl.objectives.llm.SFTLoss.html#torchrl.objectives.llm.SFTLoss). As in those losses, gradients
...
Usually a [`TransformersWrapper`](torchrl.modules.llm.TransformersWrapper.html#torchrl.modules.llm.TransformersWrapper)
...
[`apply_chat_template()`](torchrl.data.llm.History.html#torchrl.data.llm.History.apply_chat_template) when
re-tokenizing.
...
[`RetrieveLogProb`](torchrl.envs.llm.transforms.RetrieveLogProb.html#torchrl.envs.llm.transforms.RetrieveLogProb) transform
...
[`RetrieveLogProb`](torchrl.envs.llm.transforms.RetrieveLogProb.html#torchrl.envs.llm.transforms.RetrieveLogProb) constructed
...
[`RetrieveLogProb`](torchrl.envs.llm.transforms.RetrieveLogProb.html#torchrl.envs.llm.transforms.RetrieveLogProb) to
compute the teacher log-probabilities, and
[`SFTLoss`](torchrl.objectives.llm.SFTLoss.html#torchrl.objectives.llm.SFTLoss) for supervised fine-tuning
...
forward(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → [DistillationLossOutput](torchrl.objectives.llm.DistillationLossOutput.html#torchrl.objectives.llm.DistillationLossOutput)[[source]](../../_modules/torchrl/objectives/llm/distillation.html#DistillationLoss.forward)
...
from_stateful_net(*network_name: str*, *stateful_net: [Module](https://docs.pytorch.org/docs/stable/generated/torch.nn.Module.html#torch.nn.Module)*)
...
named_parameters(*prefix: str = ''*, *recurse: bool = True*) → Iterator[tuple[str, [Parameter](https://docs.pytorch.org/docs/stable/generated/torch.nn.parameter.Parameter.html#torch.nn.parameter.Parameter)]]
...
select_out_keys(**out_keys*) → [TensorDictModuleBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.nn.TensorDictModuleBase.html#tensordict.nn.TensorDictModuleBase)
...
`TensorDictModuleBase.reset_out_keys()` method.
