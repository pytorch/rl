...
*class*torchrl.envs.GymLikeEnv(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/gym_like.html#GymLikeEnv)
...
by updating info_dict_reader, see `set_info_dict_reader()` method).
...
`f"{key}"` location for each `f"{key}"` of the dictionary.
...
auto_register_info_dict(*ignore_private: bool = True*, ***, *info_dict_reader: BaseInfoDictReader = None*) → [EnvBase](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase)[[source]](../../_modules/torchrl/envs/gym_like.html#GymLikeEnv.auto_register_info_dict)

Automatically registers the info dict and appends `TensorDictPrimer` instances if needed.
...
the `torchrl.envs.utils.check_env_specs()` succeeds, whether
...
Unlike `set_info_dict_reader()`, this method will create the primers necessary to get
`check_env_specs()` to run.
...
fast_encoding(*mode: bool = True*) → T[[source]](../../_modules/torchrl/envs/gym_like.html#GymLikeEnv.fast_encoding)
...
read_action(*action*)[[source]](../../_modules/torchrl/envs/gym_like.html#GymLikeEnv.read_action)
...
read_done(*terminated: bool | None = None*, *truncated: bool | None = None*, *done: bool | None = None*) → tuple[bool | ndarray, bool | ndarray, bool | ndarray, bool][[source]](../../_modules/torchrl/envs/gym_like.html#GymLikeEnv.read_done)
...
read_obs(*observations: dict[str, Any] | [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor) | ndarray*) → dict[str, Any][[source]](../../_modules/torchrl/envs/gym_like.html#GymLikeEnv.read_obs)
...
read_reward(*reward*)[[source]](../../_modules/torchrl/envs/gym_like.html#GymLikeEnv.read_reward)

Reads the reward and maps it to the reward space.

Parameters:

**reward** ([*torch.Tensor*](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)*or**TensorDict*) - reward to be mapped.
...
set_info_dict_reader(*info_dict_reader: BaseInfoDictReader | None = None*, *ignore_private: bool = True*) → GymLikeEnv[[source]](../../_modules/torchrl/envs/gym_like.html#GymLikeEnv.set_info_dict_reader)
...
provided, `default_info_dict_reader`
will be used.
- **ignore_private** (*bool**,**optional*) - If `True`, private infos (starting with
an underscore) will be ignored. Defaults to `True`.
...
`auto_register_info_dict()`, which will ensure that the env
