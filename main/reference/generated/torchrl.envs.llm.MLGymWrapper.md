...
*class*torchrl.envs.llm.MLGymWrapper(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/llm/libs/mlgym.html#MLGymWrapper)

A thin wrapper for MLGym environments.

This specialized [`GymWrapper`](torchrl.envs.GymWrapper.html#torchrl.envs.GymWrapper) subclass defines the observation space with observation=NonTensor()
and the action space with text_response=NonTensor(), according to the [`ChatEnv`](torchrl.envs.llm.ChatEnv.html#torchrl.envs.llm.ChatEnv) API.
...
auto_register_info_dict(*ignore_private: bool = True*, ***, *info_dict_reader: BaseInfoDictReader = None*) → [EnvBase](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase)
...
`GymWrapper` and similar use this method to set their method
...
read_done(*terminated: bool | None = None*, *truncated: bool | None = None*, *done: bool | None = None*) → tuple[bool | ndarray, bool | ndarray, bool | ndarray, bool]
...
read_obs(*observations: dict[str, Any] | [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor) | ndarray*) → dict[str, Any]
...
set_info_dict_reader(*info_dict_reader: BaseInfoDictReader | None = None*, *ignore_private: bool = True*) → [GymLikeEnv](torchrl.envs.GymLikeEnv.html#torchrl.envs.GymLikeEnv)
