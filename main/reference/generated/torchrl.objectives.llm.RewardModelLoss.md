...
*class*torchrl.objectives.llm.RewardModelLoss(**args*, ***kwargs*)[[source]](../../_modules/torchrl/objectives/llm/reward.html#RewardModelLoss)

Bradley-Terry reward-model training loss for RLHF.
...
using `set_keys()`. When a score
network is provided, its declared output key is used instead.

See also

The `sota-implementations/reward_model_training` recipe for a
...
forward(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → [RewardModelLossOutput](torchrl.objectives.llm.RewardModelLossOutput.html#torchrl.objectives.llm.RewardModelLossOutput)[[source]](../../_modules/torchrl/objectives/llm/reward.html#RewardModelLoss.forward)
