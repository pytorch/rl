...
*class*torchrl.envs.MicroDuckSkillController(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/custom/mujoco/microduck_controller.html#MicroDuckSkillController)
...
[`MicroDuckSkillEnv`](torchrl.envs.MicroDuckSkillEnv.html#torchrl.envs.MicroDuckSkillEnv) incorporates this controller into a
high-level environment; [`LowLevelController`](torchrl.modules.LowLevelController.html#torchrl.modules.LowLevelController)
...
make_tensordict_primer() → [Transform](torchrl.envs.transforms.Transform.html#torchrl.envs.transforms.Transform)
