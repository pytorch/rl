...
*class*torchrl.envs.transforms.TargetMacroAction(*mode: 'torch.Tensor'*, *steps: 'torch.Tensor'*, *settle_steps: 'torch.Tensor'*, *target: 'torch.Tensor'*, ***, *batch_size*, *device=None*, *names=None*)[[source]](../../_modules/torchrl/envs/transforms/_primitive.html#TargetMacroAction)
...
*classmethod*move(*target: [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)*, ***, *steps: int = 16*, *settle_steps: int = 0*, *mode: int | IntEnum = MacroPrimitive.MOVE*) → TargetMacroAction[[source]](../../_modules/torchrl/envs/transforms/_primitive.html#TargetMacroAction.move)
...
*classmethod*wait(***, *action_dim: int*, *steps: int = 1*, *settle_steps: int = 0*, *batch_size: [Size](https://docs.pytorch.org/docs/stable/size.html#torch.Size) | tuple[int, ...] | None = None*, *dtype: [dtype](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.dtype) | None = None*, *device: [device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | None = None*) → TargetMacroAction[[source]](../../_modules/torchrl/envs/transforms/_primitive.html#TargetMacroAction.wait)
