...
*class*torchrl.objectives.value.VTrace(**args*, ***kwargs*)[[source]](../../_modules/torchrl/objectives/value/advantages.html#VTrace)
...
- **rho_thresh** (*Union**[*[*float*](torchrl.data.llm.TopKRewardSelector.html#torchrl.data.llm.TopKRewardSelector.float)*,**Tensor**]*) - rho clipping parameter for importance weights.
Defaults to `1.0`.
- **c_thresh** (*Union**[*[*float*](torchrl.data.llm.TopKRewardSelector.html#torchrl.data.llm.TopKRewardSelector.float)*,**Tensor**]*) - c clipping parameter for importance weights.
Defaults to `1.0`.
...
[`value_estimate()`](torchrl.objectives.value.GAE.html#torchrl.objectives.value.GAE.value_estimate).
...
VTrace will return an `"advantage"` entry containing the advantage value. It will also
return a `"value_target"` entry with the V-Trace target value.
...
*classmethod*for_loss(*loss_module*, ***hyperparams*)[[source]](../../_modules/torchrl/objectives/value/advantages.html#VTrace.for_loss)
