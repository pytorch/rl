...
*class*torchrl.envs.ParallelEnv(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/batched_envs.html#ParallelEnv)
...
- **create_env_kwargs** (*dict**or*[*list*](torchrl.services.RayService.html#torchrl.services.RayService.list)*of**dicts**,**optional*) - kwargs to be used with the environments being created;
...
tensors to return through the [`step()`](torchrl.envs.ModelBasedEnvBase.html#torchrl.envs.step) and [`reset()`](torchrl.envs.ModelBasedEnvBase.html#torchrl.envs.reset) methods, such as `"hidden"` etc.
- **device** (*str**,**int**,*[*torch.device*](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device)) - The device of the batched environment can be passed.
...
This parameter has no effect for the [`SerialEnv`](torchrl.envs.SerialEnv.html#torchrl.envs.SerialEnv) class.
...
with a single worker will return a [`SerialEnv`](torchrl.envs.SerialEnv.html#torchrl.envs.SerialEnv) instead.
This option has no effect with [`SerialEnv`](torchrl.envs.SerialEnv.html#torchrl.envs.SerialEnv). Defaults to `False`.
...
To be used only with `ParallelEnv` subclasses.
- **use_buffers** (*bool**,**optional*) -

whether communication between workers should
...
> specs have leaves on an MPS device, `ParallelEnv`
...
is only supported by `ParallelEnv`, starts its workers
...
This is only applicable to parallel environments such as `ParallelEnv`.
Defaults to `False`.
...
serializable (e.g., use `functools.partial()` instead of lambdas).
This parameter only affects `ParallelEnv`.
Defaults to `True`.

Note

For `ParallelEnv`, it is recommended to use `functools.partial()`
instead of lambda functions when possible, as `partial` objects are natively serializable
and avoid the overhead of [`EnvCreator`](torchrl.envs.EnvCreator.html#torchrl.envs.EnvCreator) wrapping.

Note

One can pass keyword arguments to each sub-environments using the following
technique: every keyword argument in [`reset()`](torchrl.envs.ModelBasedEnvBase.html#torchrl.envs.reset) will be passed to each
...
ParallelEnv will timeout after one of the worker is idle for a determinate amount of time.
...
do automatically. Check [`set_info_dict_reader()`](torchrl.envs.GymLikeEnv.html#torchrl.envs.GymLikeEnv.set_info_dict_reader)
...
> 
> 
> Related classes and methods: [`auto_register_info_dict()`](torchrl.envs.GymLikeEnv.html#torchrl.envs.GymLikeEnv.auto_register_info_dict)
> and `default_info_dict_reader`.
...
ParallelEnv disable gradients in all operations ([`step()`](torchrl.envs.ModelBasedEnvBase.html#torchrl.envs.step),
[`reset()`](torchrl.envs.ModelBasedEnvBase.html#torchrl.envs.reset) and `step_and_maybe_reset()`) because gradients
cannot be passed through `multiprocessing.Pipe` objects.
Only [`SerialEnv`](torchrl.envs.SerialEnv.html#torchrl.envs.SerialEnv) will support backpropagation.
...
[`EnvBase`](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase) subclass (and of
...
load_state_dict(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/batched_envs.html#ParallelEnv.load_state_dict)
...
*classmethod*make_parallel(**args*, *num_envs: int = 1*, ***parallel_kwargs*) → [EnvBase](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase)[[source]](../../_modules/torchrl/envs/batched_envs.html#ParallelEnv.make_parallel)
...
set_seed(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/batched_envs.html#ParallelEnv.set_seed)
...
state_dict(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/batched_envs.html#ParallelEnv.state_dict)
...
to(*device: [device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | str | int*)[[source]](../../_modules/torchrl/envs/batched_envs.html#ParallelEnv.to)

Move and/or cast the parameters and buffers.

This can be called as

to(*device=None*, *dtype=None*, *non_blocking=False*)[[source]](../../_modules/torchrl/envs/batched_envs.html#ParallelEnv.to)

to(*dtype*, *non_blocking=False*)[[source]](../../_modules/torchrl/envs/batched_envs.html#ParallelEnv.to)

to(*tensor*, *non_blocking=False*)[[source]](../../_modules/torchrl/envs/batched_envs.html#ParallelEnv.to)

to(*memory_format=torch.channels_last*)[[source]](../../_modules/torchrl/envs/batched_envs.html#ParallelEnv.to)
