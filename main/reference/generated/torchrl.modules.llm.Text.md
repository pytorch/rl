...
*class*torchrl.modules.llm.Text(*prompt: 'str | None' = None*, *response: 'str | None' = None*, *full: 'str | None' = None*, ***, *batch_size*, *device=None*, *names=None*)[[source]](../../_modules/torchrl/modules/llm/policies/common.html#Text)
...
*classmethod*default_spec(*shape=(-1,)*, *keys: list[Literal['prompt', 'response', 'full']] | None = None*)[[source]](../../_modules/torchrl/modules/llm/policies/common.html#Text.default_spec)
...
to_history(*tokenizer: AutoTokenizer*, *chat_template_name: str | None = None*) → [ChatHistory](torchrl.modules.llm.ChatHistory.html#torchrl.modules.llm.ChatHistory)[[source]](../../_modules/torchrl/modules/llm/policies/common.html#Text.to_history)
...
to_tokens(*tokenizer: AutoTokenizer*, *padding: bool = False*, *truncation: bool = False*, *return_tensors: str = 'pt'*) → [Tokens](torchrl.modules.llm.Tokens.html#torchrl.modules.llm.Tokens)[[source]](../../_modules/torchrl/modules/llm/policies/common.html#Text.to_tokens)
