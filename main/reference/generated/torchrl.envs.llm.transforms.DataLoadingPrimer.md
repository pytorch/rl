...
During collection, we will attempt to convert it into a tensordict using `from_dict()` or a
similar function.
...
- **primers** ([*Composite*](torchrl.data.Composite.html#torchrl.data.Composite)*|**None**,**optional*) - The primers to use for each key in the dataloader. Defaults to None.
...
- **batch_size** (*int**,*[*torch.Size*](https://docs.pytorch.org/docs/stable/size.html#torch.Size)*or**None*) -

the batch-size of the data delivered by the transform.
...
The batch-size of the Primer must match the batch-size of the parent environment (typically a
wrapper around `LLMEnv`).
...
- **use_ray_service** (*bool**,**optional*) - if `True`, returns a [`RayDataLoadingPrimer`](torchrl.envs.llm.transforms.RayDataLoadingPrimer.html#torchrl.envs.llm.transforms.RayDataLoadingPrimer) instance instead,
...
forward(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)
...
reset_dataloader()[[source]](../../_modules/torchrl/envs/llm/transforms/dataloading.html#DataLoadingPrimer.reset_dataloader)
...
transform_observation_spec(*observation_spec: [Composite](torchrl.data.Composite.html#torchrl.data.Composite)*) → [Composite](torchrl.data.Composite.html#torchrl.data.Composite)
