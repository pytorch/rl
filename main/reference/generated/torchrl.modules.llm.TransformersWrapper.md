...
*class*torchrl.modules.llm.TransformersWrapper(**args*, ***kwargs*)[[source]](../../_modules/torchrl/modules/llm/policies/transformers_wrapper.html#TransformersWrapper)
...
- **batching** (*bool**|**None**,**optional*) - Whether to enable batching. See Batching below for more details.
...
get_new_version(***kwargs*)[[source]](../../_modules/torchrl/modules/llm/policies/transformers_wrapper.html#TransformersWrapper.get_new_version)
...
repeat_interleave_causal(*sequence_lengths: [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)*) → [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)[[source]](../../_modules/torchrl/modules/llm/policies/transformers_wrapper.html#TransformersWrapper.repeat_interleave_causal)
