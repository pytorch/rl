...
*class*torchrl.envs.ToyVLAEnv(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/custom/vla.html#ToyVLAEnv)

A minimal synthetic environment speaking the canonical VLA TensorDict schema.

Observations follow the canonical VLA layout (see [the VLA reference
page](../vla.html#ref-vla)): a random camera `image` and a proprioceptive `state`
...
[`MultiStepActorWrapper`](torchrl.modules.tensordict_module.MultiStepActorWrapper.html#torchrl.modules.tensordict_module.MultiStepActorWrapper)) can be
...
[`SuccessReward`](torchrl.envs.transforms.SuccessReward.html#torchrl.envs.transforms.SuccessReward) for a binary
success-only reward).
...
pixels-rendering hook (matching [`GymEnv`](torchrl.envs.GymEnv.html#torchrl.envs.GymEnv) and
others) and feeds [`VideoRecorder`](torchrl.record.VideoRecorder.html#torchrl.record.VideoRecorder) directly.
