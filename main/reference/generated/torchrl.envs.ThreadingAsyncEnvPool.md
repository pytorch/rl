...
*class*torchrl.envs.ThreadingAsyncEnvPool(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/async_envs.html#ThreadingAsyncEnvPool)
...
This class and its subclasses should work when nested in with `TransformedEnv` and
...
_setup()[[source]](../../_modules/torchrl/envs/async_envs.html#ThreadingAsyncEnvPool._setup)

Initializes the thread pool and environment instances.

async_step_send(*tensordict*)[[source]](../../_modules/torchrl/envs/async_envs.html#ThreadingAsyncEnvPool.async_step_send)

Sends a step command to the environments.

async_step_recv(*min_get*)[[source]](../../_modules/torchrl/envs/async_envs.html#ThreadingAsyncEnvPool.async_step_recv)

Receives the results of the step command.

async_reset_send(*tensordict*)[[source]](../../_modules/torchrl/envs/async_envs.html#ThreadingAsyncEnvPool.async_reset_send)

Sends a reset command to the environments.

async_reset_recv(*min_get*)[[source]](../../_modules/torchrl/envs/async_envs.html#ThreadingAsyncEnvPool.async_reset_recv)

Receives the results of the reset command.

shutdown()[[source]](../../_modules/torchrl/envs/async_envs.html#ThreadingAsyncEnvPool.shutdown)
...
async_reset_recv(*min_get: int | None = None*, *env_index: int | None = None*, ***, *max_get: int | None = None*, *timeout: float | None = None*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/envs/async_envs.html#ThreadingAsyncEnvPool.async_reset_recv)

Collects reset results from the pool.

`min_get`, `env_index`, `max_get` and `timeout` behave as in
`async_step_recv()`; in particular `timeout` bounds the entire
call and raises `TimeoutError` (without losing results) if
fewer than `min_get` results arrive in time.

Returns:

the stacked reset results, carrying
`"env_index"`.
...
async_step_and_maybe_reset_recv(*min_get: int | None = None*, *env_index: int | None = None*, ***, *max_get: int | None = None*, *timeout: float | None = None*) → tuple[[TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase), [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)][[source]](../../_modules/torchrl/envs/async_envs.html#ThreadingAsyncEnvPool.async_step_and_maybe_reset_recv)
...
tuple of (TensorDictBase, TensorDictBase)

async_step_recv(*min_get: int | None = None*, *env_index: int | None = None*, ***, *max_get: int | None = None*, *timeout: float | None = None*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/envs/async_envs.html#ThreadingAsyncEnvPool.async_step_recv)
...
`TimeoutError` is raised; results collected so far are
...
the stacked results, carrying `"env_index"`.
...
*property*env_batch_sizes*: list[[Size](https://docs.pytorch.org/docs/stable/size.html#torch.Size)]*
...
reset(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase) | None = None*, ***kwargs*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)
