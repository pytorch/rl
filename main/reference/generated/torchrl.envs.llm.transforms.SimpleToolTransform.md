...
*class*torchrl.envs.llm.transforms.SimpleToolTransform(*tools: dict[str, Callable]*, *tool_schemas: dict[str, dict] | None = None*, *parser: LLMToolParser | None = None*, *tool_call_pattern: str | None = None*, *tool_name: str = 'tool'*, *timeout: float = 10.0*)[[source]](../../_modules/torchrl/envs/llm/transforms/tools.html#SimpleToolTransform)

A simple transform that executes tools from a dictionary of callables.
