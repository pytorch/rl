...
*class*torchrl.envs.llm.transforms.BrowserTransform(*allowed_domains: list[str] | None = None*, *headless: bool = True*, *timeout: float = 30.0*, *tokenizer=None*, *tool_name: str = 'tool'*)[[source]](../../_modules/torchrl/envs/llm/transforms/browser.html#BrowserTransform)
...
clone()[[source]](../../_modules/torchrl/envs/llm/transforms/browser.html#BrowserTransform.clone)

Clone the browser transform.

close()[[source]](../../_modules/torchrl/envs/llm/transforms/browser.html#BrowserTransform.close)
