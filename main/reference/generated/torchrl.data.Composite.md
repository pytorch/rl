...
*class*torchrl.data.Composite(**args*, ***kwargs*)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite)

A composition of TensorSpecs.

If a `TensorSpec` is the set-description of Tensor category, the `Composite` class is akin to
the [`TensorDict`](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDict.html#tensordict.TensorDict) class. Like [`TensorDict`](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDict.html#tensordict.TensorDict), it has a `shape` (akin to the
`TensorDict`'s `batch_size`) and an optional `device`.

Parameters:

- ***args** - if an unnamed argument is passed, it must be a dictionary with keys
matching the expected keys to be found in the `Composite` object.
...
- **device** ([*torch.device*](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device)*or**None*) - if not specified, the device of the composite
...
to `None`.
- **shape** ([*torch.Size*](https://docs.pytorch.org/docs/stable/size.html#torch.Size)) - the leading shape of all the leaves. Equivalent
...
cardinality() → int[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.cardinality)
...
clear_device_()[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.clear_device_)

Clears the device of the Composite.

clone() → Composite[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.clone)
...
empty() → Composite[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.empty)
...
enumerate(*use_mask: bool = False*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.enumerate)
...
erase_memoize_cache() → None[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.erase_memoize_cache)
...
expand(**shape: tuple[int, ...] | [Size](https://docs.pytorch.org/docs/stable/size.html#torch.Size)*) → Composite[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.expand)
...
get(*item*, *default=_NoDefault.ZERO*)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.get)
...
is_empty(*recurse: bool = False*)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.is_empty)
...
is_in(*val: dict | [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → bool[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.is_in)
...
items(*include_nested: bool = False*, *leaves_only: bool = False*, ***, *is_leaf: Callable[[type], bool] | None = None*, *step_mdp_static_only: bool = False*) → _CompositeSpecItemsView[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.items)
...
keys(*include_nested: bool = False*, *leaves_only: bool = False*, ***, *is_leaf: Callable[[type], bool] | None = None*, *step_mdp_static_only: bool = False*) → _CompositeSpecKeysView[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.keys)
...
lock_(*recurse: bool | None = None*) → None[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.lock_)
...
memoize_encode(*mode: bool = True*) → None[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.memoize_encode)
...
ndimension()[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.ndimension)
...
ones_update(*val: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.ones_update)

Updates a TensorDict with 1-values according to the specs.

Shapes are expected to be compatible with the specs.

pop(*key: NestedKey*, *default: Any = _NoDefault.ZERO*) → Any[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.pop)
...
project(*val: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.project)
...
rand(*shape: [Size](https://docs.pytorch.org/docs/stable/size.html#torch.Size) = None*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.rand)
...
rand_update(*val: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.rand_update)

Updates a TensorDict with random values according to the specs.

Shapes are expected to be compatible with the specs.

refine_names(**names*)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.refine_names)
...
separates(**keys: NestedKey*, *default: Any = None*) → Composite[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.separates)
...
set(*name: str*, *spec: [TensorSpec](torchrl.data.TensorSpec.html#torchrl.data.TensorSpec)*) → Composite[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.set)

Sets a spec in the Composite spec.

squeeze(*dim: int | None = None*) → Composite[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.squeeze)
...
to(*dest: [dtype](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.dtype) | [device](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device) | str | int*) → Composite[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.to)

Casts a TensorSpec to a device or a dtype.

Returns the same spec if no change is made.

to_numpy(*val: [TensorDict](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDict.html#tensordict.TensorDict)*, *safe: bool | None = None*) → dict[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.to_numpy)
...
type_check(*value: [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor) | [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*, *selected_keys: str | Sequence[str] | None = None*)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.type_check)
...
unlock_(*recurse: bool | None = None*) → T[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.unlock_)
...
unsqueeze(*dim: int*) → Composite[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.unsqueeze)
...
values(*include_nested: bool = False*, *leaves_only: bool = False*, ***, *is_leaf: Callable[[type], bool] | None = None*, *step_mdp_static_only: bool = False*) → _CompositeSpecValuesView[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.values)
...
zero(*shape: [Size](https://docs.pytorch.org/docs/stable/size.html#torch.Size) = None*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.zero)
...
zeros_update(*val: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/data/tensor_specs.html#Composite.zeros_update)
