...
*class*torchrl.data.datasets.LeRobotExperienceReplay(*repo_id: str*, ***, *root: str | Path | None = None*, *download: bool = True*, *batch_size: int | None = None*, *num_slices: int | None = None*, *slice_len: int | None = None*, *sampler: [Sampler](torchrl.data.replay_buffers.Sampler.html#torchrl.data.replay_buffers.Sampler) | None = None*, *writer: [Writer](torchrl.data.replay_buffers.Writer.html#torchrl.data.replay_buffers.Writer) | None = None*, *collate_fn: Callable | None = None*, *transform: [Transform](torchrl.envs.transforms.Transform.html#torchrl.envs.transforms.Transform) | None = None*, *key_map: dict[str, NestedKey] | None = None*, *decode_video: bool = True*, *rehydrate: bool = False*, *strict_length: bool = True*, *pin_memory: bool = False*, *prefetch: int | None = None*, *_data: TensorDictBase | None = None*)[[source]](../../_modules/torchrl/data/datasets/lerobot.html#LeRobotExperienceReplay)
