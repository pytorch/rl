...
*class*torchrl.objectives.llm.DAPO(**args*, ***kwargs*)[[source]](../../_modules/torchrl/objectives/llm/grpo.html#DAPO)

DAPO (Clip-Higher over GRPO).

Validates asymmetric clip thresholds; recommended (0.20, 0.28), see Eq. (10) in
the [DAPO](https://arxiv.org/html/2503.14476) paper.
...
alias of [`DAPOLossOutput`](torchrl.objectives.llm.DAPOLossOutput.html#torchrl.objectives.llm.DAPOLossOutput)
