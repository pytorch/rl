...
*class*torchrl.envs.transforms.MacroAction(*mode: 'torch.Tensor'*, *steps: 'torch.Tensor'*, *settle_steps: 'torch.Tensor'*, ***, *batch_size*, *device=None*, *names=None*)[[source]](../../_modules/torchrl/envs/transforms/_primitive.html#MacroAction)
