...
*class*torchrl.envs.AsyncEnvPool(**args*, ***kwargs*)[[source]](../../_modules/torchrl/envs/async_envs.html#AsyncEnvPool)
...
- **env_makers** (*Callable**[**[**]**,*[*EnvBase*](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase)*]**|*[*EnvBase*](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase)*|**list**[*[*EnvBase*](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase)*]**|**list**[**Callable**[**[**]**,*[*EnvBase*](torchrl.envs.EnvBase.html#torchrl.envs.EnvBase)*]**]*) - A callable or list of callables that create environment instances, or
...
*abstract*async_reset_recv(*min_get: int | None = None*, *env_index: int | None = None*, ***, *max_get: int | None = None*, *timeout: float | None = None*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/envs/async_envs.html#AsyncEnvPool.async_reset_recv)
...
*abstract*async_step_and_maybe_reset_recv(*min_get: int | None = None*, *env_index: int | list[int] | None = None*, ***, *max_get: int | None = None*, *timeout: float | None = None*) → tuple[[TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase), [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)][[source]](../../_modules/torchrl/envs/async_envs.html#AsyncEnvPool.async_step_and_maybe_reset_recv)
...
*abstract*async_step_recv(*min_get: int | None = None*, *env_index: int | None = None*, ***, *max_get: int | None = None*, *timeout: float | None = None*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/envs/async_envs.html#AsyncEnvPool.async_step_recv)
...
reset(*tensordict: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase) | None = None*, ***kwargs*) → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/envs/async_envs.html#AsyncEnvPool.reset)
