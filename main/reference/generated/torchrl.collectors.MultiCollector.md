...
*class*torchrl.collectors.MultiCollector(**args*, *sync: bool | None = None*, ***kwargs*)[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector)
...
- **sync** (*bool**,**optional*) - if `True`, the collector will run in sync mode ([`MultiSyncCollector`](torchrl.collectors.MultiSyncCollector.html#torchrl.collectors.MultiSyncCollector)). If
...
([`MultiSyncCollector`](torchrl.collectors.MultiSyncCollector.html#torchrl.collectors.MultiSyncCollector) exclusively).
...
resolves to `"padded"` and emits a `FutureWarning` when
...
async_shutdown(*timeout: float | None = None*)[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.async_shutdown)
...
fake_tensordict() → [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase)[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.fake_tensordict)
...
get_cached_weights(*model_id: str*)[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.get_cached_weights)
...
get_distant_attr(*attr: str*) → list[Any][[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.get_distant_attr)

Get a nested attribute from each worker collector.

get_model(*model_id: str*)[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.get_model)
...
getattr_policy(*attr*)[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.getattr_policy)
...
getattr_rb(*attr*)[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.getattr_rb)

Get an attribute from the replay buffer.

increment_version()[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.increment_version)
...
load_state_dict(*state_dict: OrderedDict*) → None[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.load_state_dict)
...
map_fn(*method_name: str*, *list_of_args: list[tuple] | None = None*, *list_of_kwargs: list[dict] | None = None*) → list[Any][[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.map_fn)

Apply a method to each worker collector.

pause()[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.pause)
...
receive_weights(*policy_or_weights: [TensorDictBase](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDictBase.html#tensordict.TensorDictBase) | None = None*)[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.receive_weights)
...
reset(*reset_idx: Sequence[bool] | None = None*) → None[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.reset)
...
set_seed(*seed: int*, *static_seed: bool = False*) → int[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.set_seed)
...
shutdown(*timeout: float | None = None*, *close_env: bool = True*, *raise_on_error: bool = True*) → None[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.shutdown)
...
start()[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.start)
...
state_dict() → OrderedDict[[source]](../../_modules/torchrl/collectors/_multi_base.html#MultiCollector.state_dict)
