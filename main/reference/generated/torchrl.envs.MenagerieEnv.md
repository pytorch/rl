...
*class*torchrl.envs.MenagerieEnv(*robot: str*, **args: Any*, *entry: str | None = None*, *menagerie_path: str | Path | None = None*, *download: bool = False*, ***kwargs: Any*)[[source]](../../_modules/torchrl/envs/custom/mujoco/menagerie.html#MenagerieEnv)

A MuJoCo Menagerie robot, loaded by name.
...
weighted sum of the [`MenagerieTask`](torchrl.envs.MenagerieTask.html#torchrl.envs.MenagerieTask) terms, all off by default; a
task of your own is a `Transform` that writes
...
the `MENAGERIE_ENV_VAR` environment variable, then from the cache of
...
resolved XML is `model_path`, next to `robot`, `entry`
and `task`; `reset_state` is the keyframe the reset draws
...
Defaults to the `MENAGERIE_ENV_VAR` environment variable,
...
- **task** ([*MenagerieTask*](torchrl.envs.MenagerieTask.html#torchrl.envs.MenagerieTask)*,**optional*) - the reset keyframe, the observed
...
[`ParallelEnv`](torchrl.envs.ParallelEnv.html#torchrl.envs.ParallelEnv) when `num_envs > 1` (or in
one process with [`SerialEnv`](torchrl.envs.SerialEnv.html#torchrl.envs.SerialEnv) when
...
>>> env = MenagerieEnv("unitree_go2", download=True, seed=0) 
>>> td = env.reset() 
>>> td["qpos"].shape, env.action_spec.shape 
...
... )
>>> env.rollout(10)["next", "reward"].shape 
torch.Size([1, 10, 1])
```
...
*classmethod*hold_pose_task(***, *pose_weight: float = 1.0*, *pose_std: float = 0.5*, *control_cost_weight: float = 0.01*, ***overrides: Any*) → [MenagerieTask](torchrl.envs.MenagerieTask.html#torchrl.envs.MenagerieTask)[[source]](../../_modules/torchrl/envs/custom/mujoco/menagerie.html#MenagerieEnv.hold_pose_task)
...
Defaults to `0.01`.
- ****overrides** - the other [`MenagerieTask`](torchrl.envs.MenagerieTask.html#torchrl.envs.MenagerieTask) fields, typically
...
*property*reset_state*: [TensorDict](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorDict.html#tensordict.TensorDict)*
...
*classmethod*resolve_model(*robot: str*, ***, *entry: str | None = None*, *menagerie_path: str | Path | None = None*, *download: bool = False*) → Path[[source]](../../_modules/torchrl/envs/custom/mujoco/menagerie.html#MenagerieEnv.resolve_model)
