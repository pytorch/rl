...
*class*torchrl.envs.transforms.HumanoidMacroAction(*mode: 'torch.Tensor'*, *steps: 'torch.Tensor'*, *settle_steps: 'torch.Tensor'*, *target: 'torch.Tensor'*, ***, *batch_size*, *device=None*, *names=None*)[[source]](../../_modules/torchrl/envs/custom/mujoco/_humanoid_primitives.html#HumanoidMacroAction)
...
*classmethod*reach_control(*target: [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)*, ***, *steps: int = 16*, *settle_steps: int = 0*) → HumanoidMacroAction[[source]](../../_modules/torchrl/envs/custom/mujoco/_humanoid_primitives.html#HumanoidMacroAction.reach_control)
