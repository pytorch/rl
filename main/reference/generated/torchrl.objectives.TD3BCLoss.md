...
*class*torchrl.objectives.TD3BCLoss(**args*, ***kwargs*)[[source]](../../_modules/torchrl/objectives/td3_bc.html#TD3BCLoss)
...
- **bounds** (*tuple**of*[*float*](torchrl.data.llm.TopKRewardSelector.html#torchrl.data.llm.TopKRewardSelector.float)*,**optional*) -
...
actor_loss(*tensordict*) → tuple[[Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor), dict][[source]](../../_modules/torchrl/objectives/td3_bc.html#TD3BCLoss.actor_loss)
...
make_value_estimator(*value_type: [ValueEstimators](torchrl.objectives.ValueEstimators.html#torchrl.objectives.ValueEstimators) = None*, ***hyperparams*)[[source]](../../_modules/torchrl/objectives/td3_bc.html#TD3BCLoss.make_value_estimator)
...
qvalue_loss(*tensordict*) → tuple[[Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor), dict][[source]](../../_modules/torchrl/objectives/td3_bc.html#TD3BCLoss.qvalue_loss)
