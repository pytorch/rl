...
*class*torchrl.modules.llm.SGLangWrapper(**args*, ***kwargs*)[[source]](../../_modules/torchrl/modules/llm/policies/sglang_wrapper.html#SGLangWrapper)

A wrapper class for SGLang models, providing a consistent interface for text generation.

This class is a subclass of `LLMWrapperBase` and provides
a unified API for handling different input modalities (history, text, tokens) with consistent
output structure using [`TensorClass`](https://docs.pytorch.org/tensordict/stable/reference/generated/tensordict.TensorClass.html#tensordict.TensorClass) objects.
...
**model** ([*AsyncSGLang*](torchrl.modules.llm.AsyncSGLang.html#torchrl.modules.llm.AsyncSGLang)*|**str*) - The SGLang backend to wrap.
- If a string URL, connects to an existing SGLang server
- If an AsyncSGLang instance, uses it directly

Keyword Arguments:

- **tokenizer** (*transformers.tokenization_utils.PreTrainedTokenizer**|**str**|**None**,**optional*) - The tokenizer to use for encoding and decoding text. If None, attempts to load
...
- **device** ([*torch.device*](https://docs.pytorch.org/docs/stable/tensor_attributes.html#torch.device)*|**None**,**optional*) - Device for computation.
...
consistency when used with [`ChatEnv`](torchrl.envs.llm.ChatEnv.html#torchrl.envs.llm.ChatEnv) with `with_tokenizer=True`
or [`IncrementalTokenizer`](torchrl.envs.llm.transforms.IncrementalTokenizer.html#torchrl.envs.llm.transforms.IncrementalTokenizer). Defaults to `False`.
...
*property*collector*: [LLMCollector](torchrl.collectors.llm.LLMCollector.html#torchrl.collectors.llm.LLMCollector) | None*
...
get_dist(**args*, ***kwargs*)[[source]](../../_modules/torchrl/modules/llm/policies/sglang_wrapper.html#SGLangWrapper.get_dist)
...
get_new_version(***kwargs*)[[source]](../../_modules/torchrl/modules/llm/policies/sglang_wrapper.html#SGLangWrapper.get_new_version)
...
register_collector(*collector: [LLMCollector](torchrl.collectors.llm.LLMCollector.html#torchrl.collectors.llm.LLMCollector)*)

Registers a weak reference to the container collector.

This is automatically called by the [`LLMCollector`](torchrl.collectors.llm.LLMCollector.html#torchrl.collectors.llm.LLMCollector) class.
