...
*class*torchrl.envs.transforms.SatelliteMacroAction(*mode: 'torch.Tensor'*, *steps: 'torch.Tensor'*, *settle_steps: 'torch.Tensor'*, *target: 'torch.Tensor'*, ***, *batch_size*, *device=None*, *names=None*)[[source]](../../_modules/torchrl/envs/custom/mujoco/_satellite_primitives.html#SatelliteMacroAction)
...
*classmethod*slew_attitude(*target_quat: [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)*, ***, *steps: int = 36*, *settle_steps: int = 8*) → SatelliteMacroAction[[source]](../../_modules/torchrl/envs/custom/mujoco/_satellite_primitives.html#SatelliteMacroAction.slew_attitude)
