...
*class*torchrl.objectives.llm.SFTLoss(**args*, ***kwargs*)[[source]](../../_modules/torchrl/objectives/llm/sft.html#SFTLoss)

Supervised fine-tuning loss.

Parameters:

- **actor_network** (*TensorDictModule*) - the actor network. Usually a [`TransformersWrapper`](torchrl.modules.llm.TransformersWrapper.html#torchrl.modules.llm.TransformersWrapper) instance,
...
- **tokenizer_kwargs** (*dict**,**optional*) - keyword arguments to pass to the tokenizer during `apply_chat_template()`.
...
The beta parameter for MinorSFT loss. This is only used when loss_function is "minor_sft".
...
[`RetrieveLogProb`](torchrl.envs.llm.transforms.RetrieveLogProb.html#torchrl.envs.llm.transforms.RetrieveLogProb) for the KL divergence computation.
