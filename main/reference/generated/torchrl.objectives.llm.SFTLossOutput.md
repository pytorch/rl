...
*class*torchrl.objectives.llm.SFTLossOutput(*loss_sft: 'torch.Tensor'*, *loss_kl_to_ref: 'torch.Tensor | None' = None*, *kl_to_ref: 'torch.Tensor | None' = None*, ***, *batch_size*, *device=None*, *names=None*)[[source]](../../_modules/torchrl/objectives/llm/sft.html#SFTLossOutput)
