...
*class*torchrl.envs.llm.transforms.MCPToolTransform(*servers: dict[str, dict]*, *tool_call_pattern: str | None = None*, *tool_name: str = 'tool'*, *timeout: float = 10.0*)[[source]](../../_modules/torchrl/envs/llm/transforms/tools.html#MCPToolTransform)
...
Example: {"browser": {"command": "npx", "args": ["@browsermcp/[mcp@latest](mailto:mcp%40latest)"]}}
...
>>> print(result["next", "history", "prompt"][..., -1].content) 
...
close()[[source]](../../_modules/torchrl/envs/llm/transforms/tools.html#MCPToolTransform.close)
