...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    pkg_path /tmp/tmpsmo6z7ji/model.pt2
    tensor(1)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [torch.onnx] Optimize the ONNX graph... ✅
    ONNX rollout took 625.0112 msec (total =  0.6250 sec since last reset).
    TorchRL version took 1864.2943 msec (total =  1.8643 sec since last reset).
