...
**00:27.695** total execution time for 29 files **from all galleries**:

| Example | Time | Mem (MB) |
| --- | --- | --- |
| [Reinforcement Learning (PPO) with TorchRL Tutorial](tutorials/coding_ppo.html#sphx-glr-tutorials-coding-ppo-py) (`reference/generated/tutorials/coding_ppo.py`) | 00:27.695 | 0.0 |
