...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    pkg_path /tmp/tmpurhwntpe/model.pt2
    tensor(1)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [torch.onnx] Optimize the ONNX graph... ✅
    ONNX rollout took 620.4774 msec (total =  0.6205 sec since last reset).
    TorchRL version took 1836.8242 msec (total =  1.8368 sec since last reset).
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 23.068 seconds)
