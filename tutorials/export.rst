...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    pkg_path /tmp/tmpp6xcrwt2/model.pt2
    tensor(1)
...
.. GENERATED FROM PYTHON SOURCE LINES 410-464
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [torch.onnx] Optimize the ONNX graph... ✅
    ONNX rollout took 626.4553 msec (total =  0.6265 sec since last reset).
    TorchRL version took 2005.1184 msec (total =  2.0051 sec since last reset).
