...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    pkg_path /tmp/tmpjthsga51/model.pt2
    tensor(1)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [torch.onnx] Optimize the ONNX graph... ✅
    ONNX rollout took 623.5614 msec (total =  0.6236 sec since last reset).
    TorchRL version took 1818.3293 msec (total =  1.8183 sec since last reset).
