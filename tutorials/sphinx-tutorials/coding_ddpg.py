...
if __name__ == "__main__":
    ...
    def make_ddpg_actor(
        ...
        print(proof_environment.transform[2].loc.shape)
        print(proof_environment.transform[2].scale.shape)
        proof_environment.transform[2].loc.copy_(transform_state_dict["loc"])
        proof_environment.transform[2].scale.copy_(transform_state_dict["scale"])
    ...
    def make_recorder(actor_model_explore, transform_state_dict):
        ...
        recorder.transform[2].loc.copy_(transform_state_dict["loc"])
        recorder.transform[2].scale.copy_(transform_state_dict["scale"])
