...
class UnityMLAgentsEnv(UnityMLAgentsWrapper):
    ...
    Examples:
        ...
        >>> import torchrl
        >>> env = torchrl.envs.UnityMLAgentsEnv(registered_name='3DBall')
        >>> td = env.reset()
        >>> td = env.step(td.update(env.full_action_spec.rand()))
        >>> td
        TensorDict(
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.__name__}(env={self.file_name}, batch_size={self.batch_size}, device={self.device})"
