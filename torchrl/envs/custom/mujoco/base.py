...
class MujocoEnv(EnvBase, abc.ABC, metaclass=_MujocoMeta):
    ...
    Args:
        ...
        max_episode_steps: truncation horizon; ``done`` only tracks
            termination (subclass :meth:`_compute_done`), use
            :class:`~torchrl.envs.transforms.TimeLimit` for truncation.
