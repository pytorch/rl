...
# from torchrl.envs.transforms.transforms import Compose, Transform  # FIXME(kamilpi)
Compose = "Compose"
Transform = "Transform"
...
class ReplayBuffer:
    ...
    def __init__(
        ...
        from torchrl.envs.transforms.transforms import Compose  # FIXME(kamilpi)
...
class TensorDictReplayBuffer(ReplayBuffer):
    ...
    def sample(self, batch_size: int, include_info: bool = False) -> Tuple[TensorDictBase, dict]:
