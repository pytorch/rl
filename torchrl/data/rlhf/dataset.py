...
from examples.rlhf.data.openai_summarize_comparisons import HERE, DATASET
from examples.rlhf.data.utils import create_memmaps, create_infinite_dataloader
...
def get_reward_dataloader(config, device, split="train"):
    ...
    return create_infinite_dataloader(data, config, CollatePairwise(device))
...
class CollatePairwise(nn.Module):
