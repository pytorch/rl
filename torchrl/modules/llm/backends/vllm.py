...
class vLLMWorker(Worker):
    ...
    def __init__(self, *args, **kwargs):
        ...
        print(f"=> in {type(self).__name__}.__init__")
    ...
    def init_weight_update_group(
        ...
        print(f"=> in {type(self).__name__}.init_weight_update_group")
        ...
        print(f"Local rank in tensor parallel group: {local_rank}")
        ...
        print(f"{type(self).__name__}.init_weight_update_group success")
...
class LLMOnDevice(LLM):
    ...
    def __init__(self, *args, bundle_indices: list | None = None, **kwargs):
        ...
        if bundle_indices is not None:
            ...
            print(f"Initializing LLM with bundle_indices={bundle_indices}")
...
def make_vllm_worker(
    ...
    **kwargs,
    ...
    if make_ray_worker:
        ...
        print(f"Creating vLLM Ray worker with tensor_parallel_size={num_devices}")
