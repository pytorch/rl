...
def bring_forward_and_squash_batch_sizes(
    ...
    """Permutes the batch dimensions according to the permute indices, then squashes all the leading dimensions except ``batch_size_unmasked``."""
