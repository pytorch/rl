...
def _wait_process_pause(pause_event, paused_event, shutdown_event):
...
def _process_env_loop(
    ...
    try:
        ...
        while not shutdown_event.is_set():
            _wait_process_pause(pause_event, paused_event, shutdown_event)
            if shutdown_event.is_set():
                break
    ...
    def _ensure_started(self) -> None:
        ...
        try:
            ...
            if self._uses_process_env_workers:
                ...
                self._result_queue = ctx.Queue(maxsize=self.frames_per_batch)
