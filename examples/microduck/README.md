...
task clock, upward base velocity while both feet are planted up to take-off
speed, and base height gained above the standing height while both feet are
off the ground), small
...
Game environments, selectors and recipes live in the optional
[rl-zoo](https://github.com/vmoens/rl-zoo). Skills and prior training remain
here. The [game integration tutorial](../../tutorials/sphinx-tutorials/microduck_games.py)
shows how the installed zoo uses TorchRL controllers, collection and PPOTrainer.
