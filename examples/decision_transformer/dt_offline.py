...
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    inference_actor, actor = make_decision_transformer_model(cfg)
    policy = actor.to(model_device)
    inference_policy = inference_actor.to(model_device)

    loss_module = make_loss(cfg.loss, actor)
    transformer_optim, temperature_optim, scheduler = make_dt_optimizer(
